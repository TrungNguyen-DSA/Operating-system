...
main(int argc, char **argv)
{
  ...
  44:	8c058593          	addi	a1,a1,-1856 # 900 <malloc+0x104>
  48:	4509                	li	a0,2
  4a:	6d4000ef          	jal	71e <fprintf>
    exit(1);
  4e:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f4:	22890913          	addi	s2,s2,552 # 918 <malloc+0x11c>
        for(; *s; s++)
