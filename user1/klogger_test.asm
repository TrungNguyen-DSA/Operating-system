...
int main(int argc, char *argv[]) { 
  ...
  18:	92450513          	addi	a0,a0,-1756 # 938 <malloc+0x14e>
  1c:	71a000ef          	jal	736 <printf>
  ...
  34:	95850513          	addi	a0,a0,-1704 # 988 <malloc+0x19e>
  38:	6fe000ef          	jal	736 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ea:	60250513          	addi	a0,a0,1538 # 9e8 <digits>
 3ee:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 680:	36cb8b93          	addi	s7,s7,876 # 9e8 <digits>
 ...
 6e2:	30290913          	addi	s2,s2,770 # 9e0 <malloc+0x1f6>
        for(; *s; s++)
