...
main(int argc, char **argv)
{
  ...
  14:	96050513          	addi	a0,a0,-1696 # 970 <malloc+0x104>
  ...
  42:	93250513          	addi	a0,a0,-1742 # 970 <malloc+0x104>
  ...
  56:	97e50513          	addi	a0,a0,-1666 # 9d0 <malloc+0x164>
  ...
  6a:	91a50513          	addi	a0,a0,-1766 # 980 <malloc+0x114>
  6e:	74a000ef          	jal	7b8 <printf>
    exit(1);
  72:	4505                	li	a0,1
  74:	2e4000ef          	jal	358 <exit>
    fprintf(2, "%s: cannot stat %s\n", s, "ff");
  78:	00001697          	auipc	a3,0x1
  7c:	92068693          	addi	a3,a3,-1760 # 998 <malloc+0x12c>
  80:	8626                	mv	a2,s1
  82:	00001597          	auipc	a1,0x1
  86:	91e58593          	addi	a1,a1,-1762 # 9a0 <malloc+0x134>
  8a:	4509                	li	a0,2
  8c:	702000ef          	jal	78e <fprintf>
    exit(1);
  90:	4505                	li	a0,1
  ...
  9c:	92050513          	addi	a0,a0,-1760 # 9b8 <malloc+0x14c>
  a0:	718000ef          	jal	7b8 <printf>
    exit(1);
  a4:	4505                	li	a0,1
  ...
  b2:	93a50513          	addi	a0,a0,-1734 # 9e8 <malloc+0x17c>
  b6:	702000ef          	jal	7b8 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 46c:	5a850513          	addi	a0,a0,1448 # a10 <digits>
 470:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 702:	312b8b93          	addi	s7,s7,786 # a10 <digits>
...
malloc(uint nbytes)
{
 ...
 8d0:	93c78793          	addi	a5,a5,-1732 # 1208 <base>
