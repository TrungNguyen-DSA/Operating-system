...
ls(char *path)
{
  ...
  f8:	a4c50513          	addi	a0,a0,-1460 # b40 <malloc+0x12c>
  fc:	065000ef          	jal	960 <printf>
      }
 ...
 122:	9f258593          	addi	a1,a1,-1550 # b10 <malloc+0xfc>
 126:	4509                	li	a0,2
 128:	00f000ef          	jal	936 <fprintf>
    return;
 12c:	bff9                	j	10a <ls+0x6e>
    fprintf(2, "ls: cannot stat %s\n", path);
 12e:	864a                	mv	a2,s2
 130:	00001597          	auipc	a1,0x1
 134:	9f858593          	addi	a1,a1,-1544 # b28 <malloc+0x114>
 138:	4509                	li	a0,2
 13a:	7fc000ef          	jal	936 <fprintf>
    close(fd);
 13e:	8526                	mv	a0,s1
 ...
 15e:	9f650513          	addi	a0,a0,-1546 # b50 <malloc+0x13c>
 162:	7fe000ef          	jal	960 <printf>
      break;
 ...
 1a2:	9a2a0a13          	addi	s4,s4,-1630 # b40 <malloc+0x12c>
        printf("ls: cannot stat %s\n", buf);
 1a6:	00001a97          	auipc	s5,0x1
 1aa:	982a8a93          	addi	s5,s5,-1662 # b28 <malloc+0x114>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ae:	a031                	j	1ba <ls+0x11e>
        printf("ls: cannot stat %s\n", buf);
 1b0:	dc040593          	addi	a1,s0,-576
 1b4:	8556                	mv	a0,s5
 1b6:	7aa000ef          	jal	960 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ba:	4641                	li	a2,16
...
main(int argc, char *argv[])
{
 ...
 25e:	90e50513          	addi	a0,a0,-1778 # b68 <malloc+0x154>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 614:	56850513          	addi	a0,a0,1384 # b78 <digits>
 618:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8aa:	2d2b8b93          	addi	s7,s7,722 # b78 <digits>
 ...
 90c:	26890913          	addi	s2,s2,616 # b70 <malloc+0x15c>
        for(; *s; s++)
