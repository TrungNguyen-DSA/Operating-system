...
user/_stack_overflow:     file format elf64-littleriscv


Disassembly of section .text:

0000000000000000 <recursive_function>:
...
void recursive_function(int depth) {
   ...
   4:	40113c23          	sd	ra,1048(sp)
   8:	40813823          	sd	s0,1040(sp)
   c:	40913423          	sd	s1,1032(sp)
  10:	42010413          	addi	s0,sp,1056
  14:	84aa                	mv	s1,a0
    ...
    for (int i = 0; i < 1024; i += 256) {
        buffer[i] = 'X';
  16:	05800793          	li	a5,88
  1a:	bef40023          	sb	a5,-1056(s0)
  1e:	cef40023          	sb	a5,-800(s0)
  22:	def40023          	sb	a5,-544(s0)
  26:	eef40023          	sb	a5,-288(s0)
    }

    printf("Depth: %d | Stack Address approx: 0x%p\n", depth, &buffer[0]);
  2a:	be040613          	addi	a2,s0,-1056
  2e:	85aa                	mv	a1,a0
  30:	00001517          	auipc	a0,0x1
  34:	96050513          	addi	a0,a0,-1696 # 990 <malloc+0xfe>
  38:	7a6000ef          	jal	7de <printf>
  ...
  40:	23f78793          	addi	a5,a5,575 # f423f <base+0xf322f>
  44:	0097db63          	bge	a5,s1,5a <recursive_function+0x5a>
        return;
    }
  ...
  48:	41813083          	ld	ra,1048(sp)
  4c:	41013403          	ld	s0,1040(sp)
  50:	40813483          	ld	s1,1032(sp)
  54:	42010113          	addi	sp,sp,1056
  58:	8082                	ret
    recursive_function(depth + 1);
  5a:	0014851b          	addiw	a0,s1,1
  5e:	fa3ff0ef          	jal	0 <recursive_function>
  62:	b7dd                	j	48 <recursive_function+0x48>
...
int main() {
  ...
  70:	94c50513          	addi	a0,a0,-1716 # 9b8 <malloc+0x126>
  74:	76a000ef          	jal	7de <printf>

    int pid = fork();
  78:	2fe000ef          	jal	376 <fork>

    if (pid < 0) {
  7c:	00054f63          	bltz	a0,9a <main+0x36>
        printf("Fork failed!\n");
        exit(1);
    }

    if (pid == 0) {
  80:	e515                	bnez	a0,ac <main+0x48>
        /* ===== TIẾN TRÌNH CON ===== */
        // Tiến trình con sẽ chịu trách nhiệm lao đầu vào Guard Page và bị hiến tế
        recursive_function(1);
  82:	4505                	li	a0,1
  84:	f7dff0ef          	jal	0 <recursive_function>
        
        // Dòng này sẽ không bao giờ được chạy tới
        printf("[FAIL] Out of recursion without crash? ❌\n");
  88:	00001517          	auipc	a0,0x1
  8c:	97050513          	addi	a0,a0,-1680 # 9f8 <malloc+0x166>
  90:	74e000ef          	jal	7de <printf>
        exit(0);
  94:	4501                	li	a0,0
  96:	2e8000ef          	jal	37e <exit>
        printf("Fork failed!\n");
  9a:	00001517          	auipc	a0,0x1
  9e:	94e50513          	addi	a0,a0,-1714 # 9e8 <malloc+0x156>
  a2:	73c000ef          	jal	7de <printf>
        exit(1);
  a6:	4505                	li	a0,1
  a8:	2d6000ef          	jal	37e <exit>
    } 
    else {
        /* ===== TIẾN TRÌNH CHA ===== */
        int status;
  ...
  b0:	2d6000ef          	jal	386 <wait>

        printf("\n--------------------------------------------------\n");
  b4:	00001517          	auipc	a0,0x1
  b8:	97450513          	addi	a0,a0,-1676 # a28 <malloc+0x196>
  bc:	722000ef          	jal	7de <printf>
        printf("[OK] Page Fault detected! Child process hit the Guard Page.\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	9a050513          	addi	a0,a0,-1632 # a60 <malloc+0x1ce>
  c8:	716000ef          	jal	7de <printf>
        printf("[OK] Stack Overflow handled safely by xv6 Kernel! ✅\n");
  cc:	00001517          	auipc	a0,0x1
  d0:	9d450513          	addi	a0,a0,-1580 # aa0 <malloc+0x20e>
  d4:	70a000ef          	jal	7de <printf>
        printf("--------------------------------------------------\n");
  d8:	00001517          	auipc	a0,0x1
  dc:	a0050513          	addi	a0,a0,-1536 # ad8 <malloc+0x246>
  e0:	6fe000ef          	jal	7de <printf>
    }
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 492:	68a50513          	addi	a0,a0,1674 # b18 <digits>
 496:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 728:	3f4b8b93          	addi	s7,s7,1012 # b18 <digits>
 ...
 78a:	38a90913          	addi	s2,s2,906 # b10 <malloc+0x27e>
        for(; *s; s++)
