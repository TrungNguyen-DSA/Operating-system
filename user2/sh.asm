...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	de4a8a93          	addi	s5,s5,-540 # 12b0 <malloc+0x16e>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	db250513          	addi	a0,a0,-590 # 1290 <malloc+0x14e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d1e60613          	addi	a2,a2,-738 # 12b8 <malloc+0x176>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d0eb0b13          	addi	s6,s6,-754 # 12d8 <malloc+0x196>
  ...
  return ret;
     ...
     5f8:	ccc50513          	addi	a0,a0,-820 # 12c0 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c8250513          	addi	a0,a0,-894 # 12c8 <malloc+0x186>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c5c60613          	addi	a2,a2,-932 # 12e0 <malloc+0x19e>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c08a0a13          	addi	s4,s4,-1016 # 12e8 <malloc+0x1a6>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	be660613          	addi	a2,a2,-1050 # 12f0 <malloc+0x1ae>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b5860613          	addi	a2,a2,-1192 # 12b8 <malloc+0x176>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b8460613          	addi	a2,a2,-1148 # 1308 <malloc+0x1c6>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b3e50513          	addi	a0,a0,-1218 # 12f8 <malloc+0x1b6>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b4a50513          	addi	a0,a0,-1206 # 1310 <malloc+0x1ce>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b8270713          	addi	a4,a4,-1150 # 1370 <malloc+0x22e>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9ce60613          	addi	a2,a2,-1586 # 1248 <malloc+0x106>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a8058593          	addi	a1,a1,-1408 # 1328 <malloc+0x1e6>
     8b0:	4509                	li	a0,2
     8b2:	7b2000ef          	jal	1064 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a0a50513          	addi	a0,a0,-1526 # 12c0 <malloc+0x17e>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a6248493          	addi	s1,s1,-1438 # 1338 <malloc+0x1f6>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	9c658593          	addi	a1,a1,-1594 # 1340 <malloc+0x1fe>
     982:	4509                	li	a0,2
     984:	6e0000ef          	jal	1064 <fprintf>
...
0000000000000d24 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     d24:	715d                	addi	sp,sp,-80
     d26:	e486                	sd	ra,72(sp)
     d28:	e0a2                	sd	s0,64(sp)
     d2a:	f84a                	sd	s2,48(sp)
     d2c:	0880                	addi	s0,sp,80
     d2e:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d30:	c299                	beqz	a3,d36 <printint+0x12>
     d32:	0805c363          	bltz	a1,db8 <printint+0x94>
  neg = 0;
     d36:	4881                	li	a7,0
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d42:	64a50513          	addi	a0,a0,1610 # 1388 <digits>
     d46:	883e                	mv	a6,a5
     d48:	2785                	addiw	a5,a5,1
     d4a:	02c5f733          	remu	a4,a1,a2
     d4e:	972a                	add	a4,a4,a0
     d50:	00074703          	lbu	a4,0(a4)
     d54:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d58:	872e                	mv	a4,a1
     d5a:	02c5d5b3          	divu	a1,a1,a2
     d5e:	0685                	addi	a3,a3,1
     d60:	fec773e3          	bgeu	a4,a2,d46 <printint+0x22>
  if(neg)
     d64:	00088b63          	beqz	a7,d7a <printint+0x56>
    buf[i++] = '-';
     d68:	fd078793          	addi	a5,a5,-48
     d6c:	97a2                	add	a5,a5,s0
     d6e:	02d00713          	li	a4,45
     d72:	fee78423          	sb	a4,-24(a5)
     d76:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d7a:	02f05a63          	blez	a5,dae <printint+0x8a>
     d7e:	fc26                	sd	s1,56(sp)
     d80:	f44e                	sd	s3,40(sp)
     d82:	fb840713          	addi	a4,s0,-72
     d86:	00f704b3          	add	s1,a4,a5
     d8a:	fff70993          	addi	s3,a4,-1
     d8e:	99be                	add	s3,s3,a5
     d90:	37fd                	addiw	a5,a5,-1
     d92:	1782                	slli	a5,a5,0x20
     d94:	9381                	srli	a5,a5,0x20
     d96:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     d9a:	fff4c583          	lbu	a1,-1(s1)
     d9e:	854a                	mv	a0,s2
     da0:	f67ff0ef          	jal	d06 <putc>
  while(--i >= 0)
     da4:	14fd                	addi	s1,s1,-1
     da6:	ff349ae3          	bne	s1,s3,d9a <printint+0x76>
     daa:	74e2                	ld	s1,56(sp)
     ...
     db6:	8082                	ret
    x = -xx;
     db8:	40b005b3          	neg	a1,a1
    neg = 1;
     dbc:	4885                	li	a7,1
    x = -xx;
     dbe:	bfad                	j	d38 <printint+0x14>

0000000000000dc0 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     dc8:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
     dca:	0005c903          	lbu	s2,0(a1)
     dce:	28090663          	beqz	s2,105a <vprintf+0x29a>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dee:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     df2:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     df6:	06c00c93          	li	s9,108
     dfa:	a005                	j	e1a <vprintf+0x5a>
        putc(fd, c0);
     dfc:	85ca                	mv	a1,s2
     dfe:	855a                	mv	a0,s6
     e00:	f07ff0ef          	jal	d06 <putc>
     e04:	a019                	j	e0a <vprintf+0x4a>
    } else if(state == '%'){
     e06:	03598263          	beq	s3,s5,e2a <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     e0a:	2485                	addiw	s1,s1,1
     e0c:	8726                	mv	a4,s1
     e0e:	009a07b3          	add	a5,s4,s1
     e12:	0007c903          	lbu	s2,0(a5)
     e16:	22090a63          	beqz	s2,104a <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     e1a:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e1e:	fe0994e3          	bnez	s3,e06 <vprintf+0x46>
      if(c0 == '%'){
     e22:	fd579de3          	bne	a5,s5,dfc <vprintf+0x3c>
        state = '%';
     e26:	89be                	mv	s3,a5
     e28:	b7cd                	j	e0a <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     ...
     e32:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e34:	c681                	beqz	a3,e3c <vprintf+0x7c>
     e36:	9752                	add	a4,a4,s4
     e38:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e3c:	05878363          	beq	a5,s8,e82 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e40:	05978d63          	beq	a5,s9,e9a <vprintf+0xda>
     ...
     e44:	07500713          	li	a4,117
     e48:	0ee78763          	beq	a5,a4,f36 <vprintf+0x176>
     ...
     e4c:	07800713          	li	a4,120
     e50:	12e78963          	beq	a5,a4,f82 <vprintf+0x1c2>
     ...
     e54:	07000713          	li	a4,112
     e58:	14e78e63          	beq	a5,a4,fb4 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e5c:	06300713          	li	a4,99
     e60:	18e78e63          	beq	a5,a4,ffc <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e64:	07300713          	li	a4,115
     e68:	1ae78463          	beq	a5,a4,1010 <vprintf+0x250>
     ...
     e70:	04e79563          	bne	a5,a4,eba <vprintf+0xfa>
        putc(fd, '%');
     e74:	02500593          	li	a1,37
     e78:	855a                	mv	a0,s6
     e7a:	e8dff0ef          	jal	d06 <putc>
     ...
     e8e:	855a                	mv	a0,s6
     e90:	e95ff0ef          	jal	d24 <printint>
     e94:	8bca                	mv	s7,s2
      state = 0;
     e96:	4981                	li	s3,0
     e98:	bf8d                	j	e0a <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     e9a:	06400793          	li	a5,100
     e9e:	02f68963          	beq	a3,a5,ed0 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     ea2:	06c00793          	li	a5,108
     ea6:	04f68263          	beq	a3,a5,eea <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     eaa:	07500793          	li	a5,117
     eae:	0af68063          	beq	a3,a5,f4e <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     eb2:	07800793          	li	a5,120
     eb6:	0ef68263          	beq	a3,a5,f9a <vprintf+0x1da>
        putc(fd, '%');
     eba:	02500593          	li	a1,37
     ebe:	855a                	mv	a0,s6
     ec0:	e47ff0ef          	jal	d06 <putc>
        putc(fd, c0);
     ec4:	85ca                	mv	a1,s2
     ec6:	855a                	mv	a0,s6
     ec8:	e3fff0ef          	jal	d06 <putc>
      state = 0;
     ecc:	4981                	li	s3,0
     ece:	bf35                	j	e0a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     ee6:	4981                	li	s3,0
        i += 1;
     ee8:	b70d                	j	e0a <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eea:	06400793          	li	a5,100
     eee:	02f60763          	beq	a2,a5,f1c <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     ef2:	07500793          	li	a5,117
     ef6:	06f60963          	beq	a2,a5,f68 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     efa:	07800793          	li	a5,120
     efe:	faf61ee3          	bne	a2,a5,eba <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f42:	855a                	mv	a0,s6
     f44:	de1ff0ef          	jal	d24 <printint>
     f48:	8bca                	mv	s7,s2
      state = 0;
     f4a:	4981                	li	s3,0
     f4c:	bd7d                	j	e0a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f64:	4981                	li	s3,0
        i += 1;
     f66:	b555                	j	e0a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     f68:	008b8913          	addi	s2,s7,8
     f6c:	4681                	li	a3,0
     f6e:	4629                	li	a2,10
     f70:	000bb583          	ld	a1,0(s7)
     f74:	855a                	mv	a0,s6
     f76:	dafff0ef          	jal	d24 <printint>
        i += 2;
     ...
     f7e:	4981                	li	s3,0
        i += 2;
     f80:	b569                	j	e0a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     f82:	008b8913          	addi	s2,s7,8
     f86:	4681                	li	a3,0
     f88:	4641                	li	a2,16
     f8a:	000be583          	lwu	a1,0(s7)
     f8e:	855a                	mv	a0,s6
     f90:	d95ff0ef          	jal	d24 <printint>
     f94:	8bca                	mv	s7,s2
      state = 0;
     f96:	4981                	li	s3,0
     f98:	bd8d                	j	e0a <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     f9a:	008b8913          	addi	s2,s7,8
     f9e:	4681                	li	a3,0
     fa0:	4641                	li	a2,16
     fa2:	000bb583          	ld	a1,0(s7)
     fa6:	855a                	mv	a0,s6
     fa8:	d7dff0ef          	jal	d24 <printint>
        i += 1;
  ...
  putc(fd, '0');
     ...
     fc2:	855a                	mv	a0,s6
     fc4:	d43ff0ef          	jal	d06 <putc>
  putc(fd, 'x');
     fc8:	07800593          	li	a1,120
     fcc:	855a                	mv	a0,s6
     fce:	d39ff0ef          	jal	d06 <putc>
     fd2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fd4:	00000b97          	auipc	s7,0x0
     fd8:	3b4b8b93          	addi	s7,s7,948 # 1388 <digits>
     fdc:	03c9d793          	srli	a5,s3,0x3c
     fe0:	97de                	add	a5,a5,s7
     fe2:	0007c583          	lbu	a1,0(a5)
     fe6:	855a                	mv	a0,s6
     fe8:	d1fff0ef          	jal	d06 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fec:	0992                	slli	s3,s3,0x4
     fee:	397d                	addiw	s2,s2,-1
     ff0:	fe0916e3          	bnez	s2,fdc <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
     ff4:	8bea                	mv	s7,s10
      state = 0;
     ff6:	4981                	li	s3,0
     ff8:	6d02                	ld	s10,0(sp)
     ffa:	bd01                	j	e0a <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
     ffc:	008b8913          	addi	s2,s7,8
    1000:	000bc583          	lbu	a1,0(s7)
    1004:	855a                	mv	a0,s6
    1006:	d01ff0ef          	jal	d06 <putc>
    100a:	8bca                	mv	s7,s2
      state = 0;
    100c:	4981                	li	s3,0
    100e:	bbf5                	j	e0a <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1010:	008b8993          	addi	s3,s7,8
    1014:	000bb903          	ld	s2,0(s7)
    1018:	00090f63          	beqz	s2,1036 <vprintf+0x276>
        for(; *s; s++)
    101c:	00094583          	lbu	a1,0(s2)
    1020:	c195                	beqz	a1,1044 <vprintf+0x284>
          putc(fd, *s);
    1022:	855a                	mv	a0,s6
    1024:	ce3ff0ef          	jal	d06 <putc>
        for(; *s; s++)
    1028:	0905                	addi	s2,s2,1
    102a:	00094583          	lbu	a1,0(s2)
    102e:	f9f5                	bnez	a1,1022 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1030:	8bce                	mv	s7,s3
      state = 0;
    1032:	4981                	li	s3,0
    1034:	bbd9                	j	e0a <vprintf+0x4a>
          s = "(null)";
    1036:	00000917          	auipc	s2,0x0
    103a:	31a90913          	addi	s2,s2,794 # 1350 <malloc+0x20e>
        for(; *s; s++)
    103e:	02800593          	li	a1,40
    1042:	b7c5                	j	1022 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1044:	8bce                	mv	s7,s3
      state = 0;
    1046:	4981                	li	s3,0
    1048:	b3c9                	j	e0a <vprintf+0x4a>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  va_start(ap, fmt);
    107c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1080:	8622                	mv	a2,s0
    1082:	d3fff0ef          	jal	dc0 <vprintf>
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    10c6:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10ca:	00001797          	auipc	a5,0x1
    10ce:	f467b783          	ld	a5,-186(a5) # 2010 <freep>
    10d2:	a02d                	j	10fc <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    10d4:	4618                	lw	a4,8(a2)
    10d6:	9f2d                	addw	a4,a4,a1
    10d8:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    10dc:	6398                	ld	a4,0(a5)
    10de:	6310                	ld	a2,0(a4)
    10e0:	a83d                	j	111e <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    10e2:	ff852703          	lw	a4,-8(a0)
    10e6:	9f31                	addw	a4,a4,a2
    10e8:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    10ea:	ff053683          	ld	a3,-16(a0)
    10ee:	a091                	j	1132 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10f0:	6398                	ld	a4,0(a5)
    10f2:	00e7e463          	bltu	a5,a4,10fa <free+0x3a>
    10f6:	00e6ea63          	bltu	a3,a4,110a <free+0x4a>
{
    10fa:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10fc:	fed7fae3          	bgeu	a5,a3,10f0 <free+0x30>
    1100:	6398                	ld	a4,0(a5)
    1102:	00e6e463          	bltu	a3,a4,110a <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1106:	fee7eae3          	bltu	a5,a4,10fa <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    111a:	fae60de3          	beq	a2,a4,10d4 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    112e:	fae68ae3          	beq	a3,a4,10e2 <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1166:	c915                	beqz	a0,119a <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    116c:	08977a63          	bgeu	a4,s1,1200 <malloc+0xbe>
  ...
  if(nu < 4096)
    1178:	8a4e                	mv	s4,s3
    117a:	0009871b          	sext.w	a4,s3
    117e:	6685                	lui	a3,0x1
    1180:	00d77363          	bgeu	a4,a3,1186 <malloc+0x44>
    1184:	6a05                	lui	s4,0x1
    1186:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    118a:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    118e:	00001917          	auipc	s2,0x1
    1192:	e8290913          	addi	s2,s2,-382 # 2010 <freep>
  if(p == SBRK_ERROR)
    1196:	5afd                	li	s5,-1
    1198:	a081                	j	11d8 <malloc+0x96>
    ...
    11a6:	ee678793          	addi	a5,a5,-282 # 2088 <base>
    11aa:	00001717          	auipc	a4,0x1
    11ae:	e6f73323          	sd	a5,-410(a4) # 2010 <freep>
    11b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    11b4:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    11b8:	b7c1                	j	1178 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    11ba:	6398                	ld	a4,0(a5)
    11bc:	e118                	sd	a4,0(a0)
    11be:	a8a9                	j	1218 <malloc+0xd6>
  hp->s.size = nu;
    11c0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11c4:	0541                	addi	a0,a0,16
    11c6:	efbff0ef          	jal	10c0 <free>
  return freep;
    11ca:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11ce:	c12d                	beqz	a0,1230 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11d0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11d2:	4798                	lw	a4,8(a5)
    11d4:	02977263          	bgeu	a4,s1,11f8 <malloc+0xb6>
    if(p == freep)
    11d8:	00093703          	ld	a4,0(s2)
    11dc:	853e                	mv	a0,a5
    11de:	fef719e3          	bne	a4,a5,11d0 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    11e2:	8552                	mv	a0,s4
    11e4:	a17ff0ef          	jal	bfa <sbrk>
  if(p == SBRK_ERROR)
    11e8:	fd551ce3          	bne	a0,s5,11c0 <malloc+0x7e>
        return 0;
    11ec:	4501                	li	a0,0
