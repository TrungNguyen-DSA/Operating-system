...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	8f278793          	addi	a5,a5,-1806 # 7900 <malloc+0x2678>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	31a50513          	addi	a0,a0,794 # 5380 <malloc+0xf8>
      6e:	166050ef          	jal	51d4 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	30050513          	addi	a0,a0,768 # 53a0 <malloc+0x118>
      a8:	12c050ef          	jal	51d4 <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	2f850513          	addi	a0,a0,760 # 53b8 <malloc+0x130>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	30250513          	addi	a0,a0,770 # 53d8 <malloc+0x150>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	2ce50513          	addi	a0,a0,718 # 53c0 <malloc+0x138>
      fa:	0da050ef          	jal	51d4 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	2e250513          	addi	a0,a0,738 # 53e8 <malloc+0x160>
     10e:	0c6050ef          	jal	51d4 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	29450513          	addi	a0,a0,660 # 5410 <malloc+0x188>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	28a50513          	addi	a0,a0,650 # 5430 <malloc+0x1a8>
     1ae:	026050ef          	jal	51d4 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	21450513          	addi	a0,a0,532 # 5458 <malloc+0x1d0>
     24c:	379040ef          	jal	4dc4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	204a8a93          	addi	s5,s5,516 # 5458 <malloc+0x1d0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	1a650513          	addi	a0,a0,422 # 5468 <malloc+0x1e0>
     2ca:	70b040ef          	jal	51d4 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	1ac50513          	addi	a0,a0,428 # 5488 <malloc+0x200>
     2e4:	6f1040ef          	jal	51d4 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	1a250513          	addi	a0,a0,418 # 54a0 <malloc+0x218>
     306:	2bf040ef          	jal	4dc4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	19298993          	addi	s3,s3,402 # 54a0 <malloc+0x218>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	15650513          	addi	a0,a0,342 # 54a0 <malloc+0x218>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	0ca58593          	addi	a1,a1,202 # 5428 <malloc+0x1a0>
     366:	22f040ef          	jal	4d94 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	15050513          	addi	a0,a0,336 # 54c0 <malloc+0x238>
     378:	65d040ef          	jal	51d4 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f7040ef          	jal	4d74 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	12650513          	addi	a0,a0,294 # 54a8 <malloc+0x220>
     38a:	64b040ef          	jal	51d4 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e5040ef          	jal	4d74 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	11450513          	addi	a0,a0,276 # 54a8 <malloc+0x220>
     39c:	639040ef          	jal	51d4 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	0f450513          	addi	a0,a0,244 # 54a0 <malloc+0x218>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	47078793          	addi	a5,a5,1136 # 7900 <malloc+0x2678>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	012a0a13          	addi	s4,s4,18 # 54d0 <malloc+0x248>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	f9450513          	addi	a0,a0,-108 # 54d8 <malloc+0x250>
     54c:	489040ef          	jal	51d4 <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	f9650513          	addi	a0,a0,-106 # 54f0 <malloc+0x268>
     562:	473040ef          	jal	51d4 <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	fb050513          	addi	a0,a0,-80 # 5520 <malloc+0x298>
     578:	45d040ef          	jal	51d4 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f6040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	fce50513          	addi	a0,a0,-50 # 5550 <malloc+0x2c8>
     58a:	44b040ef          	jal	51d4 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	fc850513          	addi	a0,a0,-56 # 5560 <malloc+0x2d8>
     5a0:	435040ef          	jal	51d4 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	34278793          	addi	a5,a5,834 # 7900 <malloc+0x2678>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	f9ea0a13          	addi	s4,s4,-98 # 5590 <malloc+0x308>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e2ea8a93          	addi	s5,s5,-466 # 5428 <malloc+0x1a0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f1a50513          	addi	a0,a0,-230 # 5598 <malloc+0x310>
     686:	34f040ef          	jal	51d4 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	f1c50513          	addi	a0,a0,-228 # 55b0 <malloc+0x328>
     69c:	339040ef          	jal	51d4 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6d2040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	eaa50513          	addi	a0,a0,-342 # 5550 <malloc+0x2c8>
     6ae:	327040ef          	jal	51d4 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6c0040ef          	jal	4d74 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	f2850513          	addi	a0,a0,-216 # 55e0 <malloc+0x358>
     6c0:	315040ef          	jal	51d4 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	f2a50513          	addi	a0,a0,-214 # 55f8 <malloc+0x370>
     6d6:	2ff040ef          	jal	51d4 <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	ce850513          	addi	a0,a0,-792 # 5410 <malloc+0x188>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	cc450513          	addi	a0,a0,-828 # 5410 <malloc+0x188>
     754:	660040ef          	jal	4db4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	cb450513          	addi	a0,a0,-844 # 5410 <malloc+0x188>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	efa58593          	addi	a1,a1,-262 # 5688 <malloc+0x400>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c4c50513          	addi	a0,a0,-948 # 5410 <malloc+0x188>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e3050513          	addi	a0,a0,-464 # 5628 <malloc+0x3a0>
     800:	1d5040ef          	jal	51d4 <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e3c50513          	addi	a0,a0,-452 # 5648 <malloc+0x3c0>
     814:	1c1040ef          	jal	51d4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e3c50513          	addi	a0,a0,-452 # 5658 <malloc+0x3d0>
     824:	1b1040ef          	jal	51d4 <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e4850513          	addi	a0,a0,-440 # 5678 <malloc+0x3f0>
     838:	19d040ef          	jal	51d4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e1850513          	addi	a0,a0,-488 # 5658 <malloc+0x3d0>
     848:	18d040ef          	jal	51d4 <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e3a50513          	addi	a0,a0,-454 # 5690 <malloc+0x408>
     85e:	177040ef          	jal	51d4 <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e4450513          	addi	a0,a0,-444 # 56b0 <malloc+0x428>
     874:	161040ef          	jal	51d4 <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e3850513          	addi	a0,a0,-456 # 56d0 <malloc+0x448>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e4c98993          	addi	s3,s3,-436 # 56f8 <malloc+0x470>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e7ca8a93          	addi	s5,s5,-388 # 5730 <malloc+0x4a8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	de250513          	addi	a0,a0,-542 # 56d0 <malloc+0x448>
  ...
  if(unlink("small") < 0){
     ...
     922:	db250513          	addi	a0,a0,-590 # 56d0 <malloc+0x448>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	d9450513          	addi	a0,a0,-620 # 56d8 <malloc+0x450>
     94c:	089040ef          	jal	51d4 <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	dae50513          	addi	a0,a0,-594 # 5708 <malloc+0x480>
     962:	073040ef          	jal	51d4 <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	dd050513          	addi	a0,a0,-560 # 5740 <malloc+0x4b8>
     978:	05d040ef          	jal	51d4 <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	de450513          	addi	a0,a0,-540 # 5768 <malloc+0x4e0>
     98c:	049040ef          	jal	51d4 <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	df050513          	addi	a0,a0,-528 # 5788 <malloc+0x500>
     9a0:	035040ef          	jal	51d4 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	df450513          	addi	a0,a0,-524 # 57a0 <malloc+0x518>
     9b4:	021040ef          	jal	51d4 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	dea50513          	addi	a0,a0,-534 # 57c0 <malloc+0x538>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	da450513          	addi	a0,a0,-604 # 57c0 <malloc+0x538>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d6c50513          	addi	a0,a0,-660 # 57c8 <malloc+0x540>
     a64:	770040ef          	jal	51d4 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	d7650513          	addi	a0,a0,-650 # 57e8 <malloc+0x560>
     a7a:	75a040ef          	jal	51d4 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	d8a50513          	addi	a0,a0,-630 # 5810 <malloc+0x588>
     a8e:	746040ef          	jal	51d4 <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	d1a50513          	addi	a0,a0,-742 # 57c0 <malloc+0x538>
     ...
     ad0:	d6450513          	addi	a0,a0,-668 # 5830 <malloc+0x5a8>
     ad4:	700040ef          	jal	51d4 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	d7650513          	addi	a0,a0,-650 # 5858 <malloc+0x5d0>
     aea:	6ea040ef          	jal	51d4 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	d7850513          	addi	a0,a0,-648 # 5870 <malloc+0x5e8>
     b00:	6d4040ef          	jal	51d4 <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	d8c50513          	addi	a0,a0,-628 # 5898 <malloc+0x610>
     b14:	6c0040ef          	jal	51d4 <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d7e50513          	addi	a0,a0,-642 # 58b0 <malloc+0x628>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	d9a58593          	addi	a1,a1,-614 # 58e0 <malloc+0x658>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d5650513          	addi	a0,a0,-682 # 58b0 <malloc+0x628>
  ...
  unlink("unlinkread");
     ...
     be6:	cce50513          	addi	a0,a0,-818 # 58b0 <malloc+0x628>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	cc250513          	addi	a0,a0,-830 # 58c0 <malloc+0x638>
     c06:	5ce040ef          	jal	51d4 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	cd650513          	addi	a0,a0,-810 # 58e8 <malloc+0x660>
     c1a:	5ba040ef          	jal	51d4 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	ce250513          	addi	a0,a0,-798 # 5908 <malloc+0x680>
     c2e:	5a6040ef          	jal	51d4 <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	cf650513          	addi	a0,a0,-778 # 5930 <malloc+0x6a8>
     c42:	592040ef          	jal	51d4 <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	d0250513          	addi	a0,a0,-766 # 5950 <malloc+0x6c8>
     c56:	57e040ef          	jal	51d4 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	d0e50513          	addi	a0,a0,-754 # 5970 <malloc+0x6e8>
     c6a:	56a040ef          	jal	51d4 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	d0e50513          	addi	a0,a0,-754 # 5990 <malloc+0x708>
     c8a:	13a040ef          	jal	4dc4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	d0a50513          	addi	a0,a0,-758 # 5998 <malloc+0x710>
     c96:	12e040ef          	jal	4dc4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	cf250513          	addi	a0,a0,-782 # 5990 <malloc+0x708>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c2e58593          	addi	a1,a1,-978 # 58e0 <malloc+0x658>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c1650513          	addi	a0,a0,-1002 # 59a0 <malloc+0x718>
     d92:	442040ef          	jal	51d4 <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c1a50513          	addi	a0,a0,-998 # 59b8 <malloc+0x730>
     da6:	42e040ef          	jal	51d4 <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c1e50513          	addi	a0,a0,-994 # 59d0 <malloc+0x748>
     dba:	41a040ef          	jal	51d4 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c2a50513          	addi	a0,a0,-982 # 59f0 <malloc+0x768>
     dce:	406040ef          	jal	51d4 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c4650513          	addi	a0,a0,-954 # 5a20 <malloc+0x798>
     de2:	3f2040ef          	jal	51d4 <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c4a50513          	addi	a0,a0,-950 # 5a38 <malloc+0x7b0>
     df6:	3de040ef          	jal	51d4 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c4e50513          	addi	a0,a0,-946 # 5a50 <malloc+0x7c8>
     e0a:	3ca040ef          	jal	51d4 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	c6250513          	addi	a0,a0,-926 # 5a78 <malloc+0x7f0>
     e1e:	3b6040ef          	jal	51d4 <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	c7e50513          	addi	a0,a0,-898 # 5aa8 <malloc+0x820>
     e32:	3a2040ef          	jal	51d4 <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c7498993          	addi	s3,s3,-908 # 5ac8 <malloc+0x840>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c4c50513          	addi	a0,a0,-948 # 5ad8 <malloc+0x850>
     e94:	340040ef          	jal	51d4 <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c4450513          	addi	a0,a0,-956 # 5af8 <malloc+0x870>
     ebc:	709030ef          	jal	4dc4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c3450513          	addi	a0,a0,-972 # 5af8 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c1aa0a13          	addi	s4,s4,-998 # 5af8 <malloc+0x870>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	bcc50513          	addi	a0,a0,-1076 # 5af8 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b6c50513          	addi	a0,a0,-1172 # 5b00 <malloc+0x878>
     f9c:	238040ef          	jal	51d4 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	b7250513          	addi	a0,a0,-1166 # 5b20 <malloc+0x898>
     fb6:	21e040ef          	jal	51d4 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	b8650513          	addi	a0,a0,-1146 # 5b48 <malloc+0x8c0>
     fca:	20a040ef          	jal	51d4 <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	39e98993          	addi	s3,s3,926 # 53b8 <malloc+0x130>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	c0878793          	addi	a5,a5,-1016 # 6c98 <malloc+0x1a10>
  ...
  if(pid == 0){
    ...
    10e8:	81c78793          	addi	a5,a5,-2020 # 7900 <malloc+0x2678>
    ...
    110c:	2b050513          	addi	a0,a0,688 # 53b8 <malloc+0x130>
    ...
    1120:	ad450513          	addi	a0,a0,-1324 # 5bf0 <malloc+0x968>
    1124:	0b0040ef          	jal	51d4 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	a3450513          	addi	a0,a0,-1484 # 5b68 <malloc+0x8e0>
    113c:	098040ef          	jal	51d4 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	a3c50513          	addi	a0,a0,-1476 # 5b88 <malloc+0x900>
    1154:	080040ef          	jal	51d4 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	a4250513          	addi	a0,a0,-1470 # 5ba8 <malloc+0x920>
    116e:	066040ef          	jal	51d4 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	a5250513          	addi	a0,a0,-1454 # 5bd0 <malloc+0x948>
    1186:	04e040ef          	jal	51d4 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e9030ef          	jal	4d74 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	06050513          	addi	a0,a0,96 # 71f0 <malloc+0x1f68>
    1198:	03c040ef          	jal	51d4 <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	a4e50513          	addi	a0,a0,-1458 # 5c18 <malloc+0x990>
    11d2:	002040ef          	jal	51d4 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	22450513          	addi	a0,a0,548 # 5410 <malloc+0x188>
  ...
  if(pid == 0){
    ...
    1216:	1fea0a13          	addi	s4,s4,510 # 5410 <malloc+0x188>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a5ea8a93          	addi	s5,s5,-1442 # 5c78 <malloc+0x9f0>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	9d250513          	addi	a0,a0,-1582 # 5c48 <malloc+0x9c0>
    127e:	757030ef          	jal	51d4 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	9d650513          	addi	a0,a0,-1578 # 5c60 <malloc+0x9d8>
    1292:	743030ef          	jal	51d4 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	9e850513          	addi	a0,a0,-1560 # 5c88 <malloc+0xa00>
    12a8:	72d030ef          	jal	51d4 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	152a0a13          	addi	s4,s4,338 # 5410 <malloc+0x188>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	9e2a8a93          	addi	s5,s5,-1566 # 5ca8 <malloc+0xa20>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	11050513          	addi	a0,a0,272 # 5410 <malloc+0x188>
  ...
  exit(xstatus);
    ...
    131a:	94a50513          	addi	a0,a0,-1718 # 5c60 <malloc+0x9d8>
    131e:	6b7030ef          	jal	51d4 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	98450513          	addi	a0,a0,-1660 # 5cb0 <malloc+0xa28>
    1334:	6a1030ef          	jal	51d4 <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	06e78793          	addi	a5,a5,110 # 53b8 <malloc+0x130>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	97a78793          	addi	a5,a5,-1670 # 5cd0 <malloc+0xa48>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	97250513          	addi	a0,a0,-1678 # 5cd8 <malloc+0xa50>
  ...
  if(pid == 0) {
    ...
    138e:	94e50513          	addi	a0,a0,-1714 # 5cd8 <malloc+0xa50>
    ...
    13a6:	95650513          	addi	a0,a0,-1706 # 5cf8 <malloc+0xa70>
    13aa:	62b030ef          	jal	51d4 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	89050513          	addi	a0,a0,-1904 # 5c48 <malloc+0x9c0>
    13c0:	615030ef          	jal	51d4 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	91450513          	addi	a0,a0,-1772 # 5ce0 <malloc+0xa58>
    13d4:	601030ef          	jal	51d4 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	fd650513          	addi	a0,a0,-42 # 53b8 <malloc+0x130>
  ...
  if(xstatus != 0)
    ...
    140e:	8fe50513          	addi	a0,a0,-1794 # 5d08 <malloc+0xa80>
    1412:	5c3030ef          	jal	51d4 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	90250513          	addi	a0,a0,-1790 # 5d20 <malloc+0xa98>
    1426:	5af030ef          	jal	51d4 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	8aa50513          	addi	a0,a0,-1878 # 5cd8 <malloc+0xa50>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	33850513          	addi	a0,a0,824 # 5788 <malloc+0x500>
    1458:	57d030ef          	jal	51d4 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	7fc50513          	addi	a0,a0,2044 # 5c60 <malloc+0x9d8>
    146c:	569030ef          	jal	51d4 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	103030ef          	jal	4d74 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	86250513          	addi	a0,a0,-1950 # 5cd8 <malloc+0xa50>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	89c50513          	addi	a0,a0,-1892 # 5d38 <malloc+0xab0>
    14a4:	531030ef          	jal	51d4 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	80850513          	addi	a0,a0,-2040 # 5d50 <malloc+0xac8>
    1550:	485030ef          	jal	51d4 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	7a650513          	addi	a0,a0,1958 # 5d68 <malloc+0xae0>
    15ca:	40b030ef          	jal	51d4 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	7aa50513          	addi	a0,a0,1962 # 5d80 <malloc+0xaf8>
    15de:	3f7030ef          	jal	51d4 <printf>
          return;
    ...
    160a:	79250513          	addi	a0,a0,1938 # 5d98 <malloc+0xb10>
    160e:	3c7030ef          	jal	51d4 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	77a50513          	addi	a0,a0,1914 # 5db8 <malloc+0xb30>
    1646:	38f030ef          	jal	51d4 <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	5a850513          	addi	a0,a0,1448 # 5c48 <malloc+0x9c0>
    16a8:	32d030ef          	jal	51d4 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	71c50513          	addi	a0,a0,1820 # 5dd0 <malloc+0xb48>
    16bc:	319030ef          	jal	51d4 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	72050513          	addi	a0,a0,1824 # 5de8 <malloc+0xb60>
    16d0:	305030ef          	jal	51d4 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	52450513          	addi	a0,a0,1316 # 5c48 <malloc+0x9c0>
    172c:	2a9030ef          	jal	51d4 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	50c50513          	addi	a0,a0,1292 # 5c48 <malloc+0x9c0>
    1744:	291030ef          	jal	51d4 <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	66e50513          	addi	a0,a0,1646 # 5e08 <malloc+0xb80>
    17a2:	233030ef          	jal	51d4 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	64250513          	addi	a0,a0,1602 # 5e18 <malloc+0xb90>
    17de:	1f7030ef          	jal	51d4 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	9e050513          	addi	a0,a0,-1568 # 71f0 <malloc+0x1f68>
    1818:	1bd030ef          	jal	51d4 <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	3b650513          	addi	a0,a0,950 # 5c48 <malloc+0x9c0>
    189a:	13b030ef          	jal	51d4 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	42a50513          	addi	a0,a0,1066 # 5ce0 <malloc+0xa58>
    18be:	117030ef          	jal	51d4 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	52450513          	addi	a0,a0,1316 # 5e38 <malloc+0xbb0>
    191c:	0b9030ef          	jal	51d4 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	51850513          	addi	a0,a0,1304 # 5e50 <malloc+0xbc8>
    1940:	095030ef          	jal	51d4 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	4ee50513          	addi	a0,a0,1262 # 5e78 <malloc+0xbf0>
    1992:	043030ef          	jal	51d4 <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	a0450513          	addi	a0,a0,-1532 # 5428 <malloc+0x1a0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9d0b0b13          	addi	s6,s6,-1584 # 5428 <malloc+0x1a0>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	440c0c13          	addi	s8,s8,1088 # 5ea0 <malloc+0xc18>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1dc50513          	addi	a0,a0,476 # 5c48 <malloc+0x9c0>
    1a74:	760030ef          	jal	51d4 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	3e450513          	addi	a0,a0,996 # 5ef0 <malloc+0xc68>
    1b14:	6c0030ef          	jal	51d4 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	38450513          	addi	a0,a0,900 # 5ea8 <malloc+0xc20>
    1b2c:	6a8030ef          	jal	51d4 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	38850513          	addi	a0,a0,904 # 5ec0 <malloc+0xc38>
    1b40:	694030ef          	jal	51d4 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	38c50513          	addi	a0,a0,908 # 5ed8 <malloc+0xc50>
    1b54:	680030ef          	jal	51d4 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	05e50513          	addi	a0,a0,94 # 5c48 <malloc+0x9c0>
    1bf2:	5e2030ef          	jal	51d4 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	31450513          	addi	a0,a0,788 # 5f18 <malloc+0xc90>
    1c0c:	5c8030ef          	jal	51d4 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	fd650513          	addi	a0,a0,-42 # 5c48 <malloc+0x9c0>
    1c7a:	55a030ef          	jal	51d4 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	2a250513          	addi	a0,a0,674 # 5f38 <malloc+0xcb0>
    1c9e:	536030ef          	jal	51d4 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	26a50513          	addi	a0,a0,618 # 5f50 <malloc+0xcc8>
    1cee:	4e6030ef          	jal	51d4 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	f4e50513          	addi	a0,a0,-178 # 5c48 <malloc+0x9c0>
    1d02:	4d2030ef          	jal	51d4 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bde78793          	addi	a5,a5,-1058 # 7900 <malloc+0x2678>
  ...
  exit(0);
    ...
    1d8e:	1ee50513          	addi	a0,a0,494 # 5f78 <malloc+0xcf0>
    1d92:	442030ef          	jal	51d4 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	eaa50513          	addi	a0,a0,-342 # 5c48 <malloc+0x9c0>
    1da6:	42e030ef          	jal	51d4 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	3e650513          	addi	a0,a0,998 # 71f0 <malloc+0x1f68>
    1e12:	3c2030ef          	jal	51d4 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	0fc50513          	addi	a0,a0,252 # 5f98 <malloc+0xd10>
    1ea4:	330030ef          	jal	51d4 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	5d450513          	addi	a0,a0,1492 # 5488 <malloc+0x200>
    1ebc:	318030ef          	jal	51d4 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	d7078793          	addi	a5,a5,-656 # 6c98 <malloc+0x1a10>
  ...
  if(ret != -1){
    ...
    1f66:	04e50513          	addi	a0,a0,78 # 5fb0 <malloc+0xd28>
    1f6a:	26a030ef          	jal	51d4 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	bf050513          	addi	a0,a0,-1040 # 5b68 <malloc+0x8e0>
    1f80:	254030ef          	jal	51d4 <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	bfa50513          	addi	a0,a0,-1030 # 5b88 <malloc+0x900>
    1f96:	23e030ef          	jal	51d4 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	c0250513          	addi	a0,a0,-1022 # 5ba8 <malloc+0x920>
    1fae:	226030ef          	jal	51d4 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	c1450513          	addi	a0,a0,-1004 # 5bd0 <malloc+0x948>
    1fc4:	210030ef          	jal	51d4 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	ff850513          	addi	a0,a0,-8 # 5ff0 <malloc+0xd68>
  ...
  if(n >= 0){
    ...
    2024:	ff050513          	addi	a0,a0,-16 # 6010 <malloc+0xd88>
    2028:	1ac030ef          	jal	51d4 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	f8250513          	addi	a0,a0,-126 # 5fb8 <malloc+0xd30>
    203e:	196030ef          	jal	51d4 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	f8650513          	addi	a0,a0,-122 # 5fd0 <malloc+0xd48>
    2052:	182030ef          	jal	51d4 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	51d020ef          	jal	4d74 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	f9c50513          	addi	a0,a0,-100 # 5ff8 <malloc+0xd70>
    2064:	170030ef          	jal	51d4 <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	f7c50513          	addi	a0,a0,-132 # 5ff0 <malloc+0xd68>
    207c:	549020ef          	jal	4dc4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	50e50513          	addi	a0,a0,1294 # 5590 <malloc+0x308>
  ...
  if(n >= 0){
    ...
    20a8:	f9c50513          	addi	a0,a0,-100 # 6040 <malloc+0xdb8>
    20ac:	128030ef          	jal	51d4 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4c3020ef          	jal	4d74 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	4e250513          	addi	a0,a0,1250 # 5598 <malloc+0x310>
    20be:	116030ef          	jal	51d4 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f4850513          	addi	a0,a0,-184 # 6068 <malloc+0xde0>
    2128:	0ac030ef          	jal	51d4 <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f1850513          	addi	a0,a0,-232 # 6088 <malloc+0xe00>
    2178:	05c030ef          	jal	51d4 <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	f2c50513          	addi	a0,a0,-212 # 60e8 <malloc+0xe60>
    21c4:	010030ef          	jal	51d4 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	ed250513          	addi	a0,a0,-302 # 60a8 <malloc+0xe20>
    21de:	7f7020ef          	jal	51d4 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	ede50513          	addi	a0,a0,-290 # 60c8 <malloc+0xe40>
    21f2:	7e3020ef          	jal	51d4 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e3650513          	addi	a0,a0,-458 # 6108 <malloc+0xe80>
    22da:	6fb020ef          	jal	51d4 <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	e6a50513          	addi	a0,a0,-406 # 6150 <malloc+0xec8>
    22ee:	6e7020ef          	jal	51d4 <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	e7250513          	addi	a0,a0,-398 # 6170 <malloc+0xee8>
    2306:	6cf020ef          	jal	51d4 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	e9a50513          	addi	a0,a0,-358 # 61b0 <malloc+0xf28>
    231e:	6b7020ef          	jal	51d4 <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	eb650513          	addi	a0,a0,-330 # 61e0 <malloc+0xf58>
    2332:	6a3020ef          	jal	51d4 <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	ed650513          	addi	a0,a0,-298 # 6218 <malloc+0xf90>
    234a:	68b020ef          	jal	51d4 <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	ed050513          	addi	a0,a0,-304 # 6240 <malloc+0xfb8>
    2378:	23d020ef          	jal	4db4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	ec250513          	addi	a0,a0,-318 # 6240 <malloc+0xfb8>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	e8a50513          	addi	a0,a0,-374 # 6248 <malloc+0xfc0>
    23c6:	60f020ef          	jal	51d4 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	e8e50513          	addi	a0,a0,-370 # 6260 <malloc+0xfd8>
    23da:	5fb020ef          	jal	51d4 <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	96a50513          	addi	a0,a0,-1686 # 5d50 <malloc+0xac8>
    23ee:	5e7020ef          	jal	51d4 <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e7050513          	addi	a0,a0,-400 # 6278 <malloc+0xff0>
  ...
  close(fd);
    ...
    2444:	82050513          	addi	a0,a0,-2016 # 5c60 <malloc+0x9d8>
    2448:	58d020ef          	jal	51d4 <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	d7a50513          	addi	a0,a0,-646 # 71f0 <malloc+0x1f68>
    247e:	557020ef          	jal	51d4 <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	d4050513          	addi	a0,a0,-704 # 71f0 <malloc+0x1f68>
    24b8:	51d020ef          	jal	51d4 <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	d0050513          	addi	a0,a0,-768 # 71f0 <malloc+0x1f68>
    24f8:	4dd020ef          	jal	51d4 <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	be050513          	addi	a0,a0,-1056 # 71f0 <malloc+0x1f68>
    2618:	3bd020ef          	jal	51d4 <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	d6850513          	addi	a0,a0,-664 # 53b8 <malloc+0x130>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	dcc78793          	addi	a5,a5,-564 # 5428 <malloc+0x1a0>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	c5a50513          	addi	a0,a0,-934 # 6300 <malloc+0x1078>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	cbc50513          	addi	a0,a0,-836 # 6378 <malloc+0x10f0>
  ...
  unlink("12345678901234");
    ...
    2744:	b4050513          	addi	a0,a0,-1216 # 6280 <malloc+0xff8>
    2748:	28d020ef          	jal	51d4 <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	b7450513          	addi	a0,a0,-1164 # 62c8 <malloc+0x1040>
    275c:	279020ef          	jal	51d4 <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	bc850513          	addi	a0,a0,-1080 # 6330 <malloc+0x10a8>
    2770:	265020ef          	jal	51d4 <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	c2c50513          	addi	a0,a0,-980 # 63a8 <malloc+0x1120>
    2784:	251020ef          	jal	51d4 <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	c7850513          	addi	a0,a0,-904 # 6408 <malloc+0x1180>
    2798:	23d020ef          	jal	51d4 <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	cbc50513          	addi	a0,a0,-836 # 6460 <malloc+0x11d8>
    27ac:	229020ef          	jal	51d4 <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	cac50513          	addi	a0,a0,-852 # 6498 <malloc+0x1210>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	c9050513          	addi	a0,a0,-880 # 64a8 <malloc+0x1220>
    2820:	1b5020ef          	jal	51d4 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	c0a50513          	addi	a0,a0,-1014 # 6498 <malloc+0x1210>
    2896:	546020ef          	jal	4ddc <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	bfa50513          	addi	a0,a0,-1030 # 6498 <malloc+0x1210>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	b0c50513          	addi	a0,a0,-1268 # 64c8 <malloc+0x1240>
    29c4:	011020ef          	jal	51d4 <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	ade50513          	addi	a0,a0,-1314 # 6500 <malloc+0x1278>
    2a2a:	7aa020ef          	jal	51d4 <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	ae250513          	addi	a0,a0,-1310 # 6518 <malloc+0x1290>
    2a3e:	796020ef          	jal	51d4 <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	afe50513          	addi	a0,a0,-1282 # 6548 <malloc+0x12c0>
    2a52:	782020ef          	jal	51d4 <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	b1250513          	addi	a0,a0,-1262 # 6570 <malloc+0x12e8>
    2a66:	76e020ef          	jal	51d4 <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	18a50513          	addi	a0,a0,394 # 5c48 <malloc+0x9c0>
    2ac6:	70e020ef          	jal	51d4 <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	a2e50513          	addi	a0,a0,-1490 # 6500 <malloc+0x1278>
    2ada:	6fa020ef          	jal	51d4 <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	aa250513          	addi	a0,a0,-1374 # 6588 <malloc+0x1300>
    2aee:	6e6020ef          	jal	51d4 <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	a4e50513          	addi	a0,a0,-1458 # 6548 <malloc+0x12c0>
    2b02:	6d2020ef          	jal	51d4 <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	98c50513          	addi	a0,a0,-1652 # 6500 <malloc+0x1278>
    2b7c:	658020ef          	jal	51d4 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	a2050513          	addi	a0,a0,-1504 # 65a8 <malloc+0x1320>
    2b90:	644020ef          	jal	51d4 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	a2c50513          	addi	a0,a0,-1492 # 65c8 <malloc+0x1340>
    2ba4:	630020ef          	jal	51d4 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	a3050513          	addi	a0,a0,-1488 # 65e0 <malloc+0x1358>
    2bb8:	61c020ef          	jal	51d4 <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b5850513          	addi	a0,a0,-1192 # 6728 <malloc+0x14a0>
    2bd8:	1ec020ef          	jal	4dc4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a1c50513          	addi	a0,a0,-1508 # 65f8 <malloc+0x1370>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	a2850513          	addi	a0,a0,-1496 # 6618 <malloc+0x1390>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b2458593          	addi	a1,a1,-1244 # 6728 <malloc+0x14a0>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	9e250513          	addi	a0,a0,-1566 # 65f8 <malloc+0x1370>
    2c1e:	1a6020ef          	jal	4dc4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a4a50513          	addi	a0,a0,-1462 # 6670 <malloc+0x13e8>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	a5e50513          	addi	a0,a0,-1442 # 6698 <malloc+0x1410>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a7a58593          	addi	a1,a1,-1414 # 66c8 <malloc+0x1440>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	a6e50513          	addi	a0,a0,-1426 # 66d0 <malloc+0x1448>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	95050513          	addi	a0,a0,-1712 # 6698 <malloc+0x1410>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	b5450513          	addi	a0,a0,-1196 # 68b0 <malloc+0x1628>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	73250513          	addi	a0,a0,1842 # 6600 <malloc+0x1378>
    2ed6:	2fe020ef          	jal	51d4 <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	73e50513          	addi	a0,a0,1854 # 6620 <malloc+0x1398>
    2eea:	2ea020ef          	jal	51d4 <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	74a50513          	addi	a0,a0,1866 # 6640 <malloc+0x13b8>
    2efe:	2d6020ef          	jal	51d4 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	76e50513          	addi	a0,a0,1902 # 6678 <malloc+0x13f0>
    2f12:	2c2020ef          	jal	51d4 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	78a50513          	addi	a0,a0,1930 # 66a8 <malloc+0x1420>
    2f26:	2ae020ef          	jal	51d4 <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	7ae50513          	addi	a0,a0,1966 # 66e0 <malloc+0x1458>
    2f3a:	29a020ef          	jal	51d4 <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	7ba50513          	addi	a0,a0,1978 # 6700 <malloc+0x1478>
    2f4e:	286020ef          	jal	51d4 <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	7d650513          	addi	a0,a0,2006 # 6730 <malloc+0x14a8>
    2f62:	272020ef          	jal	51d4 <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	7ea50513          	addi	a0,a0,2026 # 6758 <malloc+0x14d0>
    2f76:	25e020ef          	jal	51d4 <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	7f650513          	addi	a0,a0,2038 # 6778 <malloc+0x14f0>
    2f8a:	24a020ef          	jal	51d4 <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	80a50513          	addi	a0,a0,-2038 # 67a0 <malloc+0x1518>
    2f9e:	236020ef          	jal	51d4 <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	81e50513          	addi	a0,a0,-2018 # 67c8 <malloc+0x1540>
    2fb2:	222020ef          	jal	51d4 <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	83a50513          	addi	a0,a0,-1990 # 67f8 <malloc+0x1570>
    2fc6:	20e020ef          	jal	51d4 <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	85650513          	addi	a0,a0,-1962 # 6828 <malloc+0x15a0>
    2fda:	1fa020ef          	jal	51d4 <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	85a50513          	addi	a0,a0,-1958 # 6840 <malloc+0x15b8>
    2fee:	1e6020ef          	jal	51d4 <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	86650513          	addi	a0,a0,-1946 # 6860 <malloc+0x15d8>
    3002:	1d2020ef          	jal	51d4 <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	87250513          	addi	a0,a0,-1934 # 6880 <malloc+0x15f8>
    3016:	1be020ef          	jal	51d4 <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	89e50513          	addi	a0,a0,-1890 # 68c0 <malloc+0x1638>
    302a:	1aa020ef          	jal	51d4 <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	8ba50513          	addi	a0,a0,-1862 # 68f0 <malloc+0x1668>
    303e:	196020ef          	jal	51d4 <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	8c650513          	addi	a0,a0,-1850 # 6910 <malloc+0x1688>
    3052:	182020ef          	jal	51d4 <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	8d250513          	addi	a0,a0,-1838 # 6930 <malloc+0x16a8>
    3066:	16e020ef          	jal	51d4 <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	8de50513          	addi	a0,a0,-1826 # 6950 <malloc+0x16c8>
    307a:	15a020ef          	jal	51d4 <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	8fa50513          	addi	a0,a0,-1798 # 6980 <malloc+0x16f8>
    308e:	146020ef          	jal	51d4 <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	90e50513          	addi	a0,a0,-1778 # 69a8 <malloc+0x1720>
    30a2:	132020ef          	jal	51d4 <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	92250513          	addi	a0,a0,-1758 # 69d0 <malloc+0x1748>
    30b6:	11e020ef          	jal	51d4 <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	93650513          	addi	a0,a0,-1738 # 69f8 <malloc+0x1770>
    30ca:	10a020ef          	jal	51d4 <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	94250513          	addi	a0,a0,-1726 # 6a18 <malloc+0x1790>
    30de:	0f6020ef          	jal	51d4 <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	94e50513          	addi	a0,a0,-1714 # 6a38 <malloc+0x17b0>
    30f2:	0e2020ef          	jal	51d4 <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	96250513          	addi	a0,a0,-1694 # 6a60 <malloc+0x17d8>
    3106:	0ce020ef          	jal	51d4 <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	96e50513          	addi	a0,a0,-1682 # 6a80 <malloc+0x17f8>
    311a:	0ba020ef          	jal	51d4 <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	97a50513          	addi	a0,a0,-1670 # 6aa0 <malloc+0x1818>
    312e:	0a6020ef          	jal	51d4 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	98e50513          	addi	a0,a0,-1650 # 6ac8 <malloc+0x1840>
    3142:	092020ef          	jal	51d4 <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	60a50513          	addi	a0,a0,1546 # 6758 <malloc+0x14d0>
    3156:	07e020ef          	jal	51d4 <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	98650513          	addi	a0,a0,-1658 # 6ae8 <malloc+0x1860>
    316a:	06a020ef          	jal	51d4 <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	99250513          	addi	a0,a0,-1646 # 6b08 <malloc+0x1880>
    317e:	056020ef          	jal	51d4 <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	9ae50513          	addi	a0,a0,-1618 # 6b38 <malloc+0x18b0>
    3192:	042020ef          	jal	51d4 <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	9ba50513          	addi	a0,a0,-1606 # 6b58 <malloc+0x18d0>
    31a6:	02e020ef          	jal	51d4 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	94050513          	addi	a0,a0,-1728 # 6b78 <malloc+0x18f0>
    3240:	795010ef          	jal	51d4 <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	94450513          	addi	a0,a0,-1724 # 6b90 <malloc+0x1908>
    3254:	781010ef          	jal	51d4 <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	94850513          	addi	a0,a0,-1720 # 6ba8 <malloc+0x1920>
    3268:	76d010ef          	jal	51d4 <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	94c50513          	addi	a0,a0,-1716 # 6bc0 <malloc+0x1938>
    327c:	759010ef          	jal	51d4 <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	2e850513          	addi	a0,a0,744 # 6570 <malloc+0x12e8>
    3290:	745010ef          	jal	51d4 <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	94450513          	addi	a0,a0,-1724 # 6be0 <malloc+0x1958>
    32a4:	731010ef          	jal	51d4 <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	95850513          	addi	a0,a0,-1704 # 6c08 <malloc+0x1980>
    32b8:	71d010ef          	jal	51d4 <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	96450513          	addi	a0,a0,-1692 # 6c28 <malloc+0x19a0>
    32cc:	709010ef          	jal	51d4 <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	96050513          	addi	a0,a0,-1696 # 6c48 <malloc+0x19c0>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	94c50513          	addi	a0,a0,-1716 # 6c48 <malloc+0x19c0>
    3304:	2e1010ef          	jal	4de4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	98450513          	addi	a0,a0,-1660 # 6c90 <malloc+0x1a08>
  ...
  fd = open(".", 0);
    ...
    3390:	71450513          	addi	a0,a0,1812 # 5aa0 <malloc+0x818>
    3394:	221010ef          	jal	4db4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	08c58593          	addi	a1,a1,140 # 5428 <malloc+0x1a0>
  ...
  close(fd);
    ...
    33c4:	89050513          	addi	a0,a0,-1904 # 6c50 <malloc+0x19c8>
    33c8:	60d010ef          	jal	51d4 <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	89c50513          	addi	a0,a0,-1892 # 6c70 <malloc+0x19e8>
    33dc:	5f9010ef          	jal	51d4 <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	8b850513          	addi	a0,a0,-1864 # 6ca0 <malloc+0x1a18>
    33f0:	5e5010ef          	jal	51d4 <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	8a450513          	addi	a0,a0,-1884 # 6ca0 <malloc+0x1a18>
    3404:	5d1010ef          	jal	51d4 <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	8b850513          	addi	a0,a0,-1864 # 6cc8 <malloc+0x1a40>
    3418:	5bd010ef          	jal	51d4 <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	8cc50513          	addi	a0,a0,-1844 # 6cf0 <malloc+0x1a68>
    342c:	5a9010ef          	jal	51d4 <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	8e050513          	addi	a0,a0,-1824 # 6d18 <malloc+0x1a90>
    3440:	595010ef          	jal	51d4 <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	8f450513          	addi	a0,a0,-1804 # 6d40 <malloc+0x1ab8>
    3454:	581010ef          	jal	51d4 <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	90050513          	addi	a0,a0,-1792 # 6d60 <malloc+0x1ad8>
    3468:	56d010ef          	jal	51d4 <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	91450513          	addi	a0,a0,-1772 # 6d88 <malloc+0x1b00>
    347c:	559010ef          	jal	51d4 <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	900a0a13          	addi	s4,s4,-1792 # 6da0 <malloc+0x1b18>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	40048493          	addi	s1,s1,1024 # 68a8 <malloc+0x1620>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	0e0a8a93          	addi	s5,s5,224 # 5590 <malloc+0x308>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	7e098993          	addi	s3,s3,2016 # 6c98 <malloc+0x1a10>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	8e450513          	addi	a0,a0,-1820 # 6da8 <malloc+0x1b20>
    34cc:	509010ef          	jal	51d4 <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	8e850513          	addi	a0,a0,-1816 # 6dc0 <malloc+0x1b38>
    34e0:	4f5010ef          	jal	51d4 <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	08098993          	addi	s3,s3,128 # 65c0 <malloc+0x1338>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	85890913          	addi	s2,s2,-1960 # 6da0 <malloc+0x1b18>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	00850513          	addi	a0,a0,8 # 6568 <malloc+0x12e0>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	84c50513          	addi	a0,a0,-1972 # 6dd8 <malloc+0x1b50>
  ...
  if(pid == 0){
    ...
    35ac:	83050513          	addi	a0,a0,-2000 # 6dd8 <malloc+0x1b50>
    ...
    35be:	83e50513          	addi	a0,a0,-1986 # 6df8 <malloc+0x1b70>
    35c2:	413010ef          	jal	51d4 <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	81250513          	addi	a0,a0,-2030 # 6de0 <malloc+0x1b58>
    35d6:	3ff010ef          	jal	51d4 <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	66650513          	addi	a0,a0,1638 # 5c48 <malloc+0x9c0>
    35ea:	3eb010ef          	jal	51d4 <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	7d850513          	addi	a0,a0,2008 # 6dd8 <malloc+0x1b50>
    3608:	7bc010ef          	jal	4dc4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	82850513          	addi	a0,a0,-2008 # 5e38 <malloc+0xbb0>
    3618:	3bd010ef          	jal	51d4 <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	7e250513          	addi	a0,a0,2018 # 6e20 <malloc+0x1b98>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	7c250513          	addi	a0,a0,1986 # 6e20 <malloc+0x1b98>
  ...
  pause(10); // one second
    ...
    368a:	78250513          	addi	a0,a0,1922 # 5e08 <malloc+0xb80>
    368e:	347010ef          	jal	51d4 <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6e0010ef          	jal	4d74 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	78848493          	addi	s1,s1,1928 # 6e20 <malloc+0x1b98>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	76850513          	addi	a0,a0,1896 # 6e20 <malloc+0x1b98>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	52a50513          	addi	a0,a0,1322 # 5c48 <malloc+0x9c0>
    3726:	2af010ef          	jal	51d4 <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	6f850513          	addi	a0,a0,1784 # 6e30 <malloc+0x1ba8>
    3740:	295010ef          	jal	51d4 <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	69c50513          	addi	a0,a0,1692 # 5e08 <malloc+0xb80>
    3774:	261010ef          	jal	51d4 <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	4ba50513          	addi	a0,a0,1210 # 5c48 <malloc+0x9c0>
    3796:	23f010ef          	jal	51d4 <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	c6a58593          	addi	a1,a1,-918 # 5428 <malloc+0x1a0>
    ...
    37e4:	46850513          	addi	a0,a0,1128 # 5c48 <malloc+0x9c0>
    37e8:	1ed010ef          	jal	51d4 <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	65c50513          	addi	a0,a0,1628 # 6e50 <malloc+0x1bc8>
    37fc:	1d9010ef          	jal	51d4 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	64450513          	addi	a0,a0,1604 # 6e68 <malloc+0x1be0>
    382c:	1a9010ef          	jal	51d4 <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	63850513          	addi	a0,a0,1592 # 6e80 <malloc+0x1bf8>
    3850:	185010ef          	jal	51d4 <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	62a50513          	addi	a0,a0,1578 # 6e90 <malloc+0x1c08>
    386e:	167010ef          	jal	51d4 <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	38250513          	addi	a0,a0,898 # 5c48 <malloc+0x9c0>
    38ce:	107010ef          	jal	51d4 <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	4f650513          	addi	a0,a0,1270 # 5dd0 <malloc+0xb48>
    38e2:	0f3010ef          	jal	51d4 <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	41250513          	addi	a0,a0,1042 # 5d50 <malloc+0xac8>
    3946:	08f010ef          	jal	51d4 <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	cb058593          	addi	a1,a1,-848 # 7618 <malloc+0x2390>
    ...
    3988:	51c58593          	addi	a1,a1,1308 # 6ea0 <malloc+0x1c18>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4d250513          	addi	a0,a0,1234 # 6ea8 <malloc+0x1c20>
    39de:	7f6010ef          	jal	51d4 <printf>
  ...
  if(pid == 0){
    ...
    3a24:	4d850513          	addi	a0,a0,1240 # 6ef8 <malloc+0x1c70>
    3a28:	7ac010ef          	jal	51d4 <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	4a450513          	addi	a0,a0,1188 # 6ed8 <malloc+0x1c50>
    3a3c:	798010ef          	jal	51d4 <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	20050513          	addi	a0,a0,512 # 5c48 <malloc+0x9c0>
    3a50:	784010ef          	jal	51d4 <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	736010ef          	jal	5206 <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	7b0010ef          	jal	5288 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	728010ef          	jal	5206 <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	43e50513          	addi	a0,a0,1086 # 6f28 <malloc+0x1ca0>
    3af2:	6e2010ef          	jal	51d4 <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	43a50513          	addi	a0,a0,1082 # 6f48 <malloc+0x1cc0>
    3b16:	2ae010ef          	jal	4dc4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	42a50513          	addi	a0,a0,1066 # 6f48 <malloc+0x1cc0>
  ...
  if(pid == 0) {
    ...
    3b8c:	3d050513          	addi	a0,a0,976 # 6f58 <malloc+0x1cd0>
    3b90:	644010ef          	jal	51d4 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	3e450513          	addi	a0,a0,996 # 6f80 <malloc+0x1cf8>
    3ba4:	630010ef          	jal	51d4 <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	37c50513          	addi	a0,a0,892 # 6f48 <malloc+0x1cc0>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	39c50513          	addi	a0,a0,924 # 6fa0 <malloc+0x1d18>
    3c0c:	5c8010ef          	jal	51d4 <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	31450513          	addi	a0,a0,788 # 6f48 <malloc+0x1cc0>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	37250513          	addi	a0,a0,882 # 6fc8 <malloc+0x1d40>
    3c5e:	576010ef          	jal	51d4 <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	35278793          	addi	a5,a5,850 # 6fe0 <malloc+0x1d58>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	34e78793          	addi	a5,a5,846 # 6fe8 <malloc+0x1d60>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	34a78793          	addi	a5,a5,842 # 6ff0 <malloc+0x1d68>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	34678793          	addi	a5,a5,838 # 6ff8 <malloc+0x1d70>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f3450513          	addi	a0,a0,-204 # 5c48 <malloc+0x9c0>
    3d1c:	4b8010ef          	jal	51d4 <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	f6a50513          	addi	a0,a0,-150 # 5ce0 <malloc+0xa58>
    3d7e:	456010ef          	jal	51d4 <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7f1000ef          	jal	4d74 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	27850513          	addi	a0,a0,632 # 7000 <malloc+0x1d78>
    3d90:	444010ef          	jal	51d4 <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	27650513          	addi	a0,a0,630 # 7018 <malloc+0x1d90>
    3daa:	42a010ef          	jal	51d4 <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	21650513          	addi	a0,a0,534 # 7028 <malloc+0x1da0>
    3e1a:	3ba010ef          	jal	51d4 <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1d4b8b93          	addi	s7,s7,468 # 7040 <malloc+0x1db8>
  for(i = 0; i < N; i++){
    ...
    3eaa:	1a250513          	addi	a0,a0,418 # 7048 <malloc+0x1dc0>
    3eae:	326010ef          	jal	51d4 <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	18450513          	addi	a0,a0,388 # 7040 <malloc+0x1db8>
  ...
  fd = open(".", 0);
    ...
    3ee8:	bbc50513          	addi	a0,a0,-1092 # 5aa0 <malloc+0x818>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	11450513          	addi	a0,a0,276 # 7068 <malloc+0x1de0>
    3f5c:	278010ef          	jal	51d4 <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	11c50513          	addi	a0,a0,284 # 7088 <malloc+0x1e00>
    3f74:	260010ef          	jal	51d4 <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	11850513          	addi	a0,a0,280 # 70b0 <malloc+0x1e28>
    3fa0:	234010ef          	jal	51d4 <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	c9c50513          	addi	a0,a0,-868 # 5c48 <malloc+0x9c0>
    3fb4:	220010ef          	jal	51d4 <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	fee50513          	addi	a0,a0,-18 # 70e8 <malloc+0x1e60>
    4102:	4c3000ef          	jal	4dc4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	fde50513          	addi	a0,a0,-34 # 70e8 <malloc+0x1e60>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	f9250513          	addi	a0,a0,-110 # 70e8 <malloc+0x1e60>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f4650513          	addi	a0,a0,-186 # 70f8 <malloc+0x1e70>
    41ba:	01a010ef          	jal	51d4 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	f5250513          	addi	a0,a0,-174 # 7118 <malloc+0x1e90>
    41ce:	006010ef          	jal	51d4 <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	f5e50513          	addi	a0,a0,-162 # 7138 <malloc+0x1eb0>
    41e2:	7f3000ef          	jal	51d4 <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	f6a50513          	addi	a0,a0,-150 # 7158 <malloc+0x1ed0>
    41f6:	7df000ef          	jal	51d4 <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	f7650513          	addi	a0,a0,-138 # 7178 <malloc+0x1ef0>
    420a:	7cb000ef          	jal	51d4 <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	f7a50513          	addi	a0,a0,-134 # 7190 <malloc+0x1f08>
    421e:	7b7000ef          	jal	51d4 <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	eb050513          	addi	a0,a0,-336 # 70e8 <malloc+0x1e60>
    ...
    425c:	f5850513          	addi	a0,a0,-168 # 71b0 <malloc+0x1f28>
    4260:	775000ef          	jal	51d4 <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f5a50513          	addi	a0,a0,-166 # 71d0 <malloc+0x1f48>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f3450513          	addi	a0,a0,-204 # 71d0 <malloc+0x1f48>
  ...
  close(fd);
    ...
    42fa:	0c250513          	addi	a0,a0,194 # 53b8 <malloc+0x130>
    42fe:	2af000ef          	jal	4dac <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	eca50513          	addi	a0,a0,-310 # 71d0 <malloc+0x1f48>
    ...
    4322:	ec250513          	addi	a0,a0,-318 # 71e0 <malloc+0x1f58>
    4326:	6af000ef          	jal	51d4 <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	eca50513          	addi	a0,a0,-310 # 7200 <malloc+0x1f78>
    433e:	697000ef          	jal	51d4 <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	e9250513          	addi	a0,a0,-366 # 7220 <malloc+0x1f98>
    4396:	63f000ef          	jal	51d4 <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d9000ef          	jal	4d74 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	e9850513          	addi	a0,a0,-360 # 7238 <malloc+0x1fb0>
    43a8:	62d000ef          	jal	51d4 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	e0a50513          	addi	a0,a0,-502 # 7220 <malloc+0x1f98>
    441e:	5b7000ef          	jal	51d4 <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	151000ef          	jal	4d74 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e3850513          	addi	a0,a0,-456 # 7260 <malloc+0x1fd8>
    4430:	5a5000ef          	jal	51d4 <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	e2450513          	addi	a0,a0,-476 # 7270 <malloc+0x1fe8>
    4454:	581000ef          	jal	51d4 <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	de650513          	addi	a0,a0,-538 # 7288 <malloc+0x2000>
    44aa:	52b000ef          	jal	51d4 <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c5000ef          	jal	4d74 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	44c78793          	addi	a5,a5,1100 # 7900 <malloc+0x2678>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	0a8a0a13          	addi	s4,s4,168 # 5590 <malloc+0x308>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	fb0a8a93          	addi	s5,s5,-80 # 54a0 <malloc+0x218>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	d6a50513          	addi	a0,a0,-662 # 72b8 <malloc+0x2030>
    4556:	47f000ef          	jal	51d4 <printf>
    455a:	4505                	li	a0,1
    455c:	019000ef          	jal	4d74 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	d7050513          	addi	a0,a0,-656 # 72d0 <malloc+0x2048>
    4568:	46d000ef          	jal	51d4 <printf>
    456c:	4505                	li	a0,1
    456e:	007000ef          	jal	4d74 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	d6e50513          	addi	a0,a0,-658 # 72e0 <malloc+0x2058>
    457a:	45b000ef          	jal	51d4 <printf>
    457e:	4505                	li	a0,1
    4580:	7f4000ef          	jal	4d74 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	d7450513          	addi	a0,a0,-652 # 72f8 <malloc+0x2070>
    458c:	449000ef          	jal	51d4 <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d3050513          	addi	a0,a0,-720 # 7310 <malloc+0x2088>
    45e8:	3ed000ef          	jal	51d4 <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d3850513          	addi	a0,a0,-712 # 7340 <malloc+0x20b8>
    4610:	3c5000ef          	jal	51d4 <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	d4a50513          	addi	a0,a0,-694 # 7378 <malloc+0x20f0>
    4636:	39f000ef          	jal	51d4 <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d5250513          	addi	a0,a0,-686 # 73a0 <malloc+0x2118>
    4656:	37f000ef          	jal	51d4 <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d5a50513          	addi	a0,a0,-678 # 73c8 <malloc+0x2140>
    4676:	35f000ef          	jal	51d4 <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d5650513          	addi	a0,a0,-682 # 73f8 <malloc+0x2170>
    46aa:	32b000ef          	jal	51d4 <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d4ac8c93          	addi	s9,s9,-694 # 7408 <malloc+0x2180>
    name[0] = 'f';
    ...
    472a:	cf250513          	addi	a0,a0,-782 # 7418 <malloc+0x2190>
    472e:	2a7000ef          	jal	51d4 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	ca450513          	addi	a0,a0,-860 # 7438 <malloc+0x21b0>
    479c:	239000ef          	jal	51d4 <printf>
}
    ...
    47e6:	c4650513          	addi	a0,a0,-954 # 7428 <malloc+0x21a0>
    47ea:	1eb000ef          	jal	51d4 <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c4450513          	addi	a0,a0,-956 # 7450 <malloc+0x21c8>
    4814:	1c1000ef          	jal	51d4 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	c4850513          	addi	a0,a0,-952 # 7478 <malloc+0x21f0>
    4838:	19d000ef          	jal	51d4 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	c1050513          	addi	a0,a0,-1008 # 7460 <malloc+0x21d8>
    4858:	17d000ef          	jal	51d4 <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	c1450513          	addi	a0,a0,-1004 # 7480 <malloc+0x21f8>
    4874:	161000ef          	jal	51d4 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	bca50513          	addi	a0,a0,-1078 # 7488 <malloc+0x2200>
    48c6:	10f000ef          	jal	51d4 <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b4ac0c13          	addi	s8,s8,-1206 # 74a0 <malloc+0x2218>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b48d8d93          	addi	s11,s11,-1208 # 74b8 <malloc+0x2230>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	b60d0d13          	addi	s10,s10,-1184 # 74d8 <malloc+0x2250>
    ...
    49f6:	b1650513          	addi	a0,a0,-1258 # 7508 <malloc+0x2280>
    49fa:	7da000ef          	jal	51d4 <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	ac458593          	addi	a1,a1,-1340 # 7520 <malloc+0x2298>
  ...
  int continuous = 0;
    ...
    4ab4:	a8050513          	addi	a0,a0,-1408 # 7530 <malloc+0x22a8>
    4ab8:	71c000ef          	jal	51d4 <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	a9250513          	addi	a0,a0,-1390 # 7560 <malloc+0x22d8>
    4ad6:	6fe000ef          	jal	51d4 <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4e4c:	1101                	addi	sp,sp,-32
    4e4e:	ec06                	sd	ra,24(sp)
    4e50:	e822                	sd	s0,16(sp)
    4e52:	1000                	addi	s0,sp,32
    4e54:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4e58:	4605                	li	a2,1
    4e5a:	fef40593          	addi	a1,s0,-17
    4e5e:	f37ff0ef          	jal	4d94 <write>
}
    4e62:	60e2                	ld	ra,24(sp)
    4e64:	6442                	ld	s0,16(sp)
    4e66:	6105                	addi	sp,sp,32
    4e68:	8082                	ret

0000000000004e6a <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4e6a:	715d                	addi	sp,sp,-80
    4e6c:	e486                	sd	ra,72(sp)
    4e6e:	e0a2                	sd	s0,64(sp)
    4e70:	f84a                	sd	s2,48(sp)
    4e72:	0880                	addi	s0,sp,80
    4e74:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e76:	c299                	beqz	a3,4e7c <printint+0x12>
    4e78:	0805c363          	bltz	a1,4efe <printint+0x94>
  neg = 0;
    4e7c:	4881                	li	a7,0
    4e7e:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4e88:	b2450513          	addi	a0,a0,-1244 # 79a8 <digits>
    4e8c:	883e                	mv	a6,a5
    4e8e:	2785                	addiw	a5,a5,1
    4e90:	02c5f733          	remu	a4,a1,a2
    4e94:	972a                	add	a4,a4,a0
    4e96:	00074703          	lbu	a4,0(a4)
    4e9a:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4e9e:	872e                	mv	a4,a1
    4ea0:	02c5d5b3          	divu	a1,a1,a2
    4ea4:	0685                	addi	a3,a3,1
    4ea6:	fec773e3          	bgeu	a4,a2,4e8c <printint+0x22>
  if(neg)
    4eaa:	00088b63          	beqz	a7,4ec0 <printint+0x56>
    buf[i++] = '-';
    4eae:	fd078793          	addi	a5,a5,-48
    4eb2:	97a2                	add	a5,a5,s0
    4eb4:	02d00713          	li	a4,45
    4eb8:	fee78423          	sb	a4,-24(a5)
    4ebc:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4ec0:	02f05a63          	blez	a5,4ef4 <printint+0x8a>
    4ec4:	fc26                	sd	s1,56(sp)
    4ec6:	f44e                	sd	s3,40(sp)
    4ec8:	fb840713          	addi	a4,s0,-72
    4ecc:	00f704b3          	add	s1,a4,a5
    4ed0:	fff70993          	addi	s3,a4,-1
    4ed4:	99be                	add	s3,s3,a5
    4ed6:	37fd                	addiw	a5,a5,-1
    4ed8:	1782                	slli	a5,a5,0x20
    4eda:	9381                	srli	a5,a5,0x20
    4edc:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4ee0:	fff4c583          	lbu	a1,-1(s1)
    4ee4:	854a                	mv	a0,s2
    4ee6:	f67ff0ef          	jal	4e4c <putc>
  while(--i >= 0)
    4eea:	14fd                	addi	s1,s1,-1
    4eec:	ff349ae3          	bne	s1,s3,4ee0 <printint+0x76>
    4ef0:	74e2                	ld	s1,56(sp)
    4ef2:	79a2                	ld	s3,40(sp)
}
    4ef4:	60a6                	ld	ra,72(sp)
    4ef6:	6406                	ld	s0,64(sp)
    4ef8:	7942                	ld	s2,48(sp)
    4efa:	6161                	addi	sp,sp,80
    4efc:	8082                	ret
    x = -xx;
    4efe:	40b005b3          	neg	a1,a1
    neg = 1;
    4f02:	4885                	li	a7,1
    x = -xx;
    4f04:	bfad                	j	4e7e <printint+0x14>

0000000000004f06 <vprintf>:
}
...
{
    4f06:	711d                	addi	sp,sp,-96
    4f08:	ec86                	sd	ra,88(sp)
    4f0a:	e8a2                	sd	s0,80(sp)
    4f0c:	e0ca                	sd	s2,64(sp)
    4f0e:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4f10:	0005c903          	lbu	s2,0(a1)
    4f14:	28090663          	beqz	s2,51a0 <vprintf+0x29a>
    4f18:	e4a6                	sd	s1,72(sp)
    4f1a:	fc4e                	sd	s3,56(sp)
    4f1c:	f852                	sd	s4,48(sp)
    4f1e:	f456                	sd	s5,40(sp)
    4f20:	f05a                	sd	s6,32(sp)
    4f22:	ec5e                	sd	s7,24(sp)
    4f24:	e862                	sd	s8,16(sp)
    4f26:	e466                	sd	s9,8(sp)
    4f28:	8b2a                	mv	s6,a0
    4f2a:	8a2e                	mv	s4,a1
    4f2c:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f34:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f38:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f3c:	06c00c93          	li	s9,108
    4f40:	a005                	j	4f60 <vprintf+0x5a>
        putc(fd, c0);
    4f42:	85ca                	mv	a1,s2
    4f44:	855a                	mv	a0,s6
    4f46:	f07ff0ef          	jal	4e4c <putc>
    4f4a:	a019                	j	4f50 <vprintf+0x4a>
    } else if(state == '%'){
    4f4c:	03598263          	beq	s3,s5,4f70 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f50:	2485                	addiw	s1,s1,1
    4f52:	8726                	mv	a4,s1
    4f54:	009a07b3          	add	a5,s4,s1
    4f58:	0007c903          	lbu	s2,0(a5)
    4f5c:	22090a63          	beqz	s2,5190 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4f60:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f64:	fe0994e3          	bnez	s3,4f4c <vprintf+0x46>
      if(c0 == '%'){
    4f68:	fd579de3          	bne	a5,s5,4f42 <vprintf+0x3c>
        state = '%';
    4f6c:	89be                	mv	s3,a5
    4f6e:	b7cd                	j	4f50 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f70:	00ea06b3          	add	a3,s4,a4
    4f74:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f78:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f7a:	c681                	beqz	a3,4f82 <vprintf+0x7c>
    4f7c:	9752                	add	a4,a4,s4
    4f7e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f82:	05878363          	beq	a5,s8,4fc8 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4f86:	05978d63          	beq	a5,s9,4fe0 <vprintf+0xda>
    ...
    4f8a:	07500713          	li	a4,117
    4f8e:	0ee78763          	beq	a5,a4,507c <vprintf+0x176>
    ...
    4f92:	07800713          	li	a4,120
    4f96:	12e78963          	beq	a5,a4,50c8 <vprintf+0x1c2>
    ...
    4f9a:	07000713          	li	a4,112
    4f9e:	14e78e63          	beq	a5,a4,50fa <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4fa2:	06300713          	li	a4,99
    4fa6:	18e78e63          	beq	a5,a4,5142 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4faa:	07300713          	li	a4,115
    4fae:	1ae78463          	beq	a5,a4,5156 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4fb2:	02500713          	li	a4,37
    4fb6:	04e79563          	bne	a5,a4,5000 <vprintf+0xfa>
        putc(fd, '%');
    4fba:	02500593          	li	a1,37
    4fbe:	855a                	mv	a0,s6
    4fc0:	e8dff0ef          	jal	4e4c <putc>
      ...
      state = 0;
    4fc4:	4981                	li	s3,0
    4fc6:	b769                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4fc8:	008b8913          	addi	s2,s7,8
    4fcc:	4685                	li	a3,1
    4fce:	4629                	li	a2,10
    4fd0:	000ba583          	lw	a1,0(s7)
    4fd4:	855a                	mv	a0,s6
    4fd6:	e95ff0ef          	jal	4e6a <printint>
    4fda:	8bca                	mv	s7,s2
      state = 0;
    4fdc:	4981                	li	s3,0
    4fde:	bf8d                	j	4f50 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4fe0:	06400793          	li	a5,100
    4fe4:	02f68963          	beq	a3,a5,5016 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4fe8:	06c00793          	li	a5,108
    4fec:	04f68263          	beq	a3,a5,5030 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4ff0:	07500793          	li	a5,117
    4ff4:	0af68063          	beq	a3,a5,5094 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4ff8:	07800793          	li	a5,120
    4ffc:	0ef68263          	beq	a3,a5,50e0 <vprintf+0x1da>
        putc(fd, '%');
    5000:	02500593          	li	a1,37
    5004:	855a                	mv	a0,s6
    5006:	e47ff0ef          	jal	4e4c <putc>
        putc(fd, c0);
    500a:	85ca                	mv	a1,s2
    500c:	855a                	mv	a0,s6
    500e:	e3fff0ef          	jal	4e4c <putc>
      state = 0;
    5012:	4981                	li	s3,0
    5014:	bf35                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    5022:	855a                	mv	a0,s6
    5024:	e47ff0ef          	jal	4e6a <printint>
        i += 1;
    ...
    502c:	4981                	li	s3,0
        i += 1;
    502e:	b70d                	j	4f50 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5030:	06400793          	li	a5,100
    5034:	02f60763          	beq	a2,a5,5062 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5038:	07500793          	li	a5,117
    503c:	06f60963          	beq	a2,a5,50ae <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5040:	07800793          	li	a5,120
    5044:	faf61ee3          	bne	a2,a5,5000 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5048:	008b8913          	addi	s2,s7,8
    504c:	4681                	li	a3,0
    504e:	4641                	li	a2,16
    5050:	000bb583          	ld	a1,0(s7)
    5054:	855a                	mv	a0,s6
    5056:	e15ff0ef          	jal	4e6a <printint>
        i += 2;
    505a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    505c:	8bca                	mv	s7,s2
      state = 0;
    505e:	4981                	li	s3,0
        i += 2;
    5060:	bdc5                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    506e:	855a                	mv	a0,s6
    5070:	dfbff0ef          	jal	4e6a <printint>
        i += 2;
    5074:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    5076:	8bca                	mv	s7,s2
      state = 0;
    5078:	4981                	li	s3,0
        i += 2;
    507a:	bdd9                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    507c:	008b8913          	addi	s2,s7,8
    5080:	4681                	li	a3,0
    5082:	4629                	li	a2,10
    5084:	000be583          	lwu	a1,0(s7)
    5088:	855a                	mv	a0,s6
    508a:	de1ff0ef          	jal	4e6a <printint>
    508e:	8bca                	mv	s7,s2
      state = 0;
    5090:	4981                	li	s3,0
    5092:	bd7d                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5094:	008b8913          	addi	s2,s7,8
    5098:	4681                	li	a3,0
    509a:	4629                	li	a2,10
    509c:	000bb583          	ld	a1,0(s7)
    50a0:	855a                	mv	a0,s6
    50a2:	dc9ff0ef          	jal	4e6a <printint>
        i += 1;
    ...
    50aa:	4981                	li	s3,0
        i += 1;
    50ac:	b555                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    50ae:	008b8913          	addi	s2,s7,8
    50b2:	4681                	li	a3,0
    50b4:	4629                	li	a2,10
    50b6:	000bb583          	ld	a1,0(s7)
    50ba:	855a                	mv	a0,s6
    50bc:	dafff0ef          	jal	4e6a <printint>
        i += 2;
    50c0:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    50c2:	8bca                	mv	s7,s2
      state = 0;
    50c4:	4981                	li	s3,0
        i += 2;
    50c6:	b569                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    50c8:	008b8913          	addi	s2,s7,8
    50cc:	4681                	li	a3,0
    50ce:	4641                	li	a2,16
    50d0:	000be583          	lwu	a1,0(s7)
    50d4:	855a                	mv	a0,s6
    50d6:	d95ff0ef          	jal	4e6a <printint>
    50da:	8bca                	mv	s7,s2
      state = 0;
    50dc:	4981                	li	s3,0
    50de:	bd8d                	j	4f50 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    50e0:	008b8913          	addi	s2,s7,8
    50e4:	4681                	li	a3,0
    50e6:	4641                	li	a2,16
    50e8:	000bb583          	ld	a1,0(s7)
    50ec:	855a                	mv	a0,s6
    50ee:	d7dff0ef          	jal	4e6a <printint>
        i += 1;
    50f2:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    50f4:	8bca                	mv	s7,s2
      state = 0;
    50f6:	4981                	li	s3,0
        i += 1;
    50f8:	bda1                	j	4f50 <vprintf+0x4a>
    50fa:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    50fc:	008b8d13          	addi	s10,s7,8
    5100:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5104:	03000593          	li	a1,48
    5108:	855a                	mv	a0,s6
    510a:	d43ff0ef          	jal	4e4c <putc>
  putc(fd, 'x');
    510e:	07800593          	li	a1,120
    5112:	855a                	mv	a0,s6
    5114:	d39ff0ef          	jal	4e4c <putc>
    5118:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    511a:	00003b97          	auipc	s7,0x3
    511e:	88eb8b93          	addi	s7,s7,-1906 # 79a8 <digits>
    5122:	03c9d793          	srli	a5,s3,0x3c
    5126:	97de                	add	a5,a5,s7
    5128:	0007c583          	lbu	a1,0(a5)
    512c:	855a                	mv	a0,s6
    512e:	d1fff0ef          	jal	4e4c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5132:	0992                	slli	s3,s3,0x4
    5134:	397d                	addiw	s2,s2,-1
    5136:	fe0916e3          	bnez	s2,5122 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    513a:	8bea                	mv	s7,s10
      state = 0;
    513c:	4981                	li	s3,0
    513e:	6d02                	ld	s10,0(sp)
    5140:	bd01                	j	4f50 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    5142:	008b8913          	addi	s2,s7,8
    5146:	000bc583          	lbu	a1,0(s7)
    514a:	855a                	mv	a0,s6
    514c:	d01ff0ef          	jal	4e4c <putc>
    5150:	8bca                	mv	s7,s2
      state = 0;
    5152:	4981                	li	s3,0
    5154:	bbf5                	j	4f50 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    5156:	008b8993          	addi	s3,s7,8
    515a:	000bb903          	ld	s2,0(s7)
    515e:	00090f63          	beqz	s2,517c <vprintf+0x276>
        for(; *s; s++)
    5162:	00094583          	lbu	a1,0(s2)
    5166:	c195                	beqz	a1,518a <vprintf+0x284>
          putc(fd, *s);
    5168:	855a                	mv	a0,s6
    516a:	ce3ff0ef          	jal	4e4c <putc>
        for(; *s; s++)
    516e:	0905                	addi	s2,s2,1
    5170:	00094583          	lbu	a1,0(s2)
    5174:	f9f5                	bnez	a1,5168 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5176:	8bce                	mv	s7,s3
      state = 0;
    5178:	4981                	li	s3,0
    517a:	bbd9                	j	4f50 <vprintf+0x4a>
          s = "(null)";
    517c:	00002917          	auipc	s2,0x2
    5180:	77c90913          	addi	s2,s2,1916 # 78f8 <malloc+0x2670>
        for(; *s; s++)
    5184:	02800593          	li	a1,40
    5188:	b7c5                	j	5168 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    518a:	8bce                	mv	s7,s3
      state = 0;
    518c:	4981                	li	s3,0
    518e:	b3c9                	j	4f50 <vprintf+0x4a>
    5190:	64a6                	ld	s1,72(sp)
    5192:	79e2                	ld	s3,56(sp)
    5194:	7a42                	ld	s4,48(sp)
    5196:	7aa2                	ld	s5,40(sp)
    5198:	7b02                	ld	s6,32(sp)
    519a:	6be2                	ld	s7,24(sp)
    519c:	6c42                	ld	s8,16(sp)
    519e:	6ca2                	ld	s9,8(sp)
    }
  }
}
    51a0:	60e6                	ld	ra,88(sp)
    51a2:	6446                	ld	s0,80(sp)
    51a4:	6906                	ld	s2,64(sp)
    51a6:	6125                	addi	sp,sp,96
    51a8:	8082                	ret

00000000000051aa <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    51aa:	715d                	addi	sp,sp,-80
    51ac:	ec06                	sd	ra,24(sp)
    51ae:	e822                	sd	s0,16(sp)
    51b0:	1000                	addi	s0,sp,32
    51b2:	e010                	sd	a2,0(s0)
    51b4:	e414                	sd	a3,8(s0)
    51b6:	e818                	sd	a4,16(s0)
    51b8:	ec1c                	sd	a5,24(s0)
    51ba:	03043023          	sd	a6,32(s0)
    51be:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    51c2:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    51c6:	8622                	mv	a2,s0
    51c8:	d3fff0ef          	jal	4f06 <vprintf>
}
    51cc:	60e2                	ld	ra,24(sp)
    51ce:	6442                	ld	s0,16(sp)
    51d0:	6161                	addi	sp,sp,80
    51d2:	8082                	ret

00000000000051d4 <printf>:

void
printf(const char *fmt, ...)
{
    51d4:	711d                	addi	sp,sp,-96
    51d6:	ec06                	sd	ra,24(sp)
    51d8:	e822                	sd	s0,16(sp)
    51da:	1000                	addi	s0,sp,32
    51dc:	e40c                	sd	a1,8(s0)
    51de:	e810                	sd	a2,16(s0)
    51e0:	ec14                	sd	a3,24(s0)
    51e2:	f018                	sd	a4,32(s0)
    51e4:	f41c                	sd	a5,40(s0)
    51e6:	03043823          	sd	a6,48(s0)
    51ea:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    51ee:	00840613          	addi	a2,s0,8
    51f2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    51f6:	85aa                	mv	a1,a0
    51f8:	4505                	li	a0,1
    51fa:	d0dff0ef          	jal	4f06 <vprintf>
}
    51fe:	60e2                	ld	ra,24(sp)
    5200:	6442                	ld	s0,16(sp)
    5202:	6125                	addi	sp,sp,96
    5204:	8082                	ret

0000000000005206 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5206:	1141                	addi	sp,sp,-16
    5208:	e422                	sd	s0,8(sp)
    520a:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    520c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5210:	00003797          	auipc	a5,0x3
    5214:	2807b783          	ld	a5,640(a5) # 8490 <freep>
    5218:	a02d                	j	5242 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    521a:	4618                	lw	a4,8(a2)
    521c:	9f2d                	addw	a4,a4,a1
    521e:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5222:	6398                	ld	a4,0(a5)
    5224:	6310                	ld	a2,0(a4)
    5226:	a83d                	j	5264 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5228:	ff852703          	lw	a4,-8(a0)
    522c:	9f31                	addw	a4,a4,a2
    522e:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5230:	ff053683          	ld	a3,-16(a0)
    5234:	a091                	j	5278 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5236:	6398                	ld	a4,0(a5)
    5238:	00e7e463          	bltu	a5,a4,5240 <free+0x3a>
    523c:	00e6ea63          	bltu	a3,a4,5250 <free+0x4a>
{
    5240:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5242:	fed7fae3          	bgeu	a5,a3,5236 <free+0x30>
    5246:	6398                	ld	a4,0(a5)
    5248:	00e6e463          	bltu	a3,a4,5250 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    524c:	fee7eae3          	bltu	a5,a4,5240 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5250:	ff852583          	lw	a1,-8(a0)
    5254:	6390                	ld	a2,0(a5)
    5256:	02059813          	slli	a6,a1,0x20
    525a:	01c85713          	srli	a4,a6,0x1c
    525e:	9736                	add	a4,a4,a3
    5260:	fae60de3          	beq	a2,a4,521a <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5264:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5268:	4790                	lw	a2,8(a5)
    526a:	02061593          	slli	a1,a2,0x20
    526e:	01c5d713          	srli	a4,a1,0x1c
    5272:	973e                	add	a4,a4,a5
    5274:	fae68ae3          	beq	a3,a4,5228 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5278:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    527a:	00003717          	auipc	a4,0x3
    527e:	20f73b23          	sd	a5,534(a4) # 8490 <freep>
}
    5282:	6422                	ld	s0,8(sp)
    5284:	0141                	addi	sp,sp,16
    5286:	8082                	ret

0000000000005288 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5288:	7139                	addi	sp,sp,-64
    528a:	fc06                	sd	ra,56(sp)
    528c:	f822                	sd	s0,48(sp)
    528e:	f426                	sd	s1,40(sp)
    5290:	ec4e                	sd	s3,24(sp)
    5292:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5294:	02051493          	slli	s1,a0,0x20
    5298:	9081                	srli	s1,s1,0x20
    529a:	04bd                	addi	s1,s1,15
    529c:	8091                	srli	s1,s1,0x4
    529e:	0014899b          	addiw	s3,s1,1
    52a2:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    52a4:	00003517          	auipc	a0,0x3
    52a8:	1ec53503          	ld	a0,492(a0) # 8490 <freep>
    52ac:	c915                	beqz	a0,52e0 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52ae:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    52b0:	4798                	lw	a4,8(a5)
    52b2:	08977a63          	bgeu	a4,s1,5346 <malloc+0xbe>
    52b6:	f04a                	sd	s2,32(sp)
    52b8:	e852                	sd	s4,16(sp)
    52ba:	e456                	sd	s5,8(sp)
    52bc:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    52be:	8a4e                	mv	s4,s3
    52c0:	0009871b          	sext.w	a4,s3
    52c4:	6685                	lui	a3,0x1
    52c6:	00d77363          	bgeu	a4,a3,52cc <malloc+0x44>
    52ca:	6a05                	lui	s4,0x1
    52cc:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    52d0:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    52d4:	00003917          	auipc	s2,0x3
    52d8:	1bc90913          	addi	s2,s2,444 # 8490 <freep>
  if(p == SBRK_ERROR)
    52dc:	5afd                	li	s5,-1
    52de:	a081                	j	531e <malloc+0x96>
    52e0:	f04a                	sd	s2,32(sp)
    52e2:	e852                	sd	s4,16(sp)
    52e4:	e456                	sd	s5,8(sp)
    52e6:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    52e8:	0000a797          	auipc	a5,0xa
    52ec:	9d078793          	addi	a5,a5,-1584 # ecb8 <base>
    52f0:	00003717          	auipc	a4,0x3
    52f4:	1af73023          	sd	a5,416(a4) # 8490 <freep>
    52f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    52fa:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    52fe:	b7c1                	j	52be <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    5300:	6398                	ld	a4,0(a5)
    5302:	e118                	sd	a4,0(a0)
    5304:	a8a9                	j	535e <malloc+0xd6>
  hp->s.size = nu;
    5306:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    530a:	0541                	addi	a0,a0,16
    530c:	efbff0ef          	jal	5206 <free>
  return freep;
    5310:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5314:	c12d                	beqz	a0,5376 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5316:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5318:	4798                	lw	a4,8(a5)
    531a:	02977263          	bgeu	a4,s1,533e <malloc+0xb6>
    if(p == freep)
    531e:	00093703          	ld	a4,0(s2)
    5322:	853e                	mv	a0,a5
    5324:	fef719e3          	bne	a4,a5,5316 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5328:	8552                	mv	a0,s4
    532a:	a17ff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    532e:	fd551ce3          	bne	a0,s5,5306 <malloc+0x7e>
        return 0;
    5332:	4501                	li	a0,0
    5334:	7902                	ld	s2,32(sp)
    5336:	6a42                	ld	s4,16(sp)
    5338:	6aa2                	ld	s5,8(sp)
    533a:	6b02                	ld	s6,0(sp)
    533c:	a03d                	j	536a <malloc+0xe2>
    533e:	7902                	ld	s2,32(sp)
    5340:	6a42                	ld	s4,16(sp)
    5342:	6aa2                	ld	s5,8(sp)
    5344:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5346:	fae48de3          	beq	s1,a4,5300 <malloc+0x78>
        p->s.size -= nunits;
    534a:	4137073b          	subw	a4,a4,s3
    534e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5350:	02071693          	slli	a3,a4,0x20
    5354:	01c6d713          	srli	a4,a3,0x1c
    5358:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    535a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    535e:	00003717          	auipc	a4,0x3
    5362:	12a73923          	sd	a0,306(a4) # 8490 <freep>
      return (void*)(p + 1);
    5366:	01078513          	addi	a0,a5,16
  }
}
    536a:	70e2                	ld	ra,56(sp)
    536c:	7442                	ld	s0,48(sp)
    536e:	74a2                	ld	s1,40(sp)
    5370:	69e2                	ld	s3,24(sp)
    5372:	6121                	addi	sp,sp,64
    5374:	8082                	ret
    5376:	7902                	ld	s2,32(sp)
    5378:	6a42                	ld	s4,16(sp)
    537a:	6aa2                	ld	s5,8(sp)
    537c:	6b02                	ld	s6,0(sp)
    537e:	b7f5                	j	536a <malloc+0xe2>
